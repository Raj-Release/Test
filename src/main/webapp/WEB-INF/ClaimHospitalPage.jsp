...
<div class="col-xs-6 col-md-6 col-lg-6">
	...
	<thead>
		<tr><td ><strong>S.No</strong></td><td ><strong>Cashless Type</strong></td><td ><strong>Treatment Type</strong></td><td ><strong>Status</strong></td><td ><strong>Requested Amount</strong></td><td ><strong>Approved Amount</strong></td>
		<td ><strong>Reason</strong></td><td ><strong>View Letter</strong></td>
		</tr>
		</thead>
		<tbody>
		<c:forEach items="${cashless}" var="cashless">
		
		<tr><td >${cashless.getSno()}</td><td>${cashless.getReferenceType()}</td><td >${cashless.getTreatementType()}</td><td>${cashless.getStatus()}</td><td >${cashless.getRequestedAmt()}</td><td>${cashless.getApprovedAmt()}</td><td>${cashless.getRemarks()}</td>
...
<div class="row">
	...
	<table class="table table-condensed table-bordered table-hover">
	 <thead>
		...
		<td ><strong>Bill Classification</strong></td><td ><strong>Status</strong></td><td ><strong>Remarks</strong></td></tr>
		</thead>
		<tbody>
...
<%-- 	<div class="row">
   ...
   <div class="row">
	...
	<thead>
		...
		<tr><td >${payment.getSerialNo()}</td><td >${payment.getDocReceivedFrom()}</td><td >${payment.getClaimType()}</td><td>${payment.getFaApprovalDateValue()}</td><td >${payment.getAmount()}</td><td >${payment.getStatus()}</td>
