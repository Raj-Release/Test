...
<div class="col-xs-12 col-md-12 col-lg-12">
	...
	<table  class="table table-condensed">
		<tbody>
			<tr>     
				<td width="300px"><strong>Diagnosis </strong></td>
               	<td>${daignosisName}</td>
          	</tr>
			<tr>     
				<td width="300px"><strong>Status of Cashless </strong></td>
               	<td>${preauth.getStatus().getProcessValue()}</td>
          	</tr>
          	<tr>     
				<td width="300px"><strong>Total Pre-Auth Approved Amount </strong></td>
	...
	<thead>
		<tr><td ><strong>S.No</strong></td><td ><strong>Reference Number </strong></td><td ><strong>Reference Type</strong></td><td ><strong>Preauth Received Data & Time</strong></td><td ><strong>Pre-auth Response Date & Time</strong></td><td ><strong>Approved Amount</strong></td>
	      <td ><strong>Status</strong></td><td ><strong>Remarks</strong></td><td ><strong>Medical Remarks</strong></td><td ><strong>Negotiated with</strong></td>
		</tr>
		</thead>
		<tbody>
		<c:forEach items="${cashless}" var="cashless">
		
		<tr><td >${cashless.getSno()}</td><td >${cashless.getReferenceNo()}</td><td>${cashless.getReferenceType()}</td><td >${cashless.getPreauthCreatedDate()}</td><td >${cashless.getPreauthModifiedDate()}</td><td>${cashless.getApprovedAmt()}</td><td>${cashless.getStatus()}</td>
		<td>${cashless.getRemarks()}</td> <td>${cashless.getMedicalRemarks()}</td><td>${cashless.getNegotiatedWith()}</td>
...
<div class="row">
	...
	<table class="table table-condensed table-bordered table-hover">
	 <thead>
		...
		<td ><strong>Bill Classification</strong></td><td ><strong>Status</strong></td><td ><strong>Remarks</strong></td><td></td><td></td><td></td></tr>
		</thead>
		<tbody>
		...
		<td><form action = "ClaimStatusServlet" method="post"><a href="claimstatus?acknowledgement=${reimbursement.getAcknowledgementToken()}" target="_blank">View Acknowledgement Details</a></form></td>
		...
		<%-- <td><form action = "ClaimStatusServlet" method="post"><a href="claimstatus?query=${reimbursement.getAcknowledgementToken()" target="_blank">View Query Details</a></form></td> </tr> --%>
		...
		<td><form action = "ClaimStatusServlet" method="post"><a href="claimstatus?intim_num=${intimation.getIntimationId()}&rod_num=${reimbursement.getReimbursementKey()}" target="_blank">View Query Details</a></form></td> </tr> --%>
	...
	<thead>
		...
		<td><form action = "ClaimStatusServlet" method="post"><a href="claimstatus?billdetails=${item.getBillDtslToken()}" target="_blank">View Bill Details</a></form></td>
