...
<div class="col-xs-6 col-md-6 col-lg-6">
		...
		<tbody>
			...
			<tr>     
				<td ><strong>Status of Cashless </strong></td>
               	<td>${preauth.getStatus().getWebsiteStatus()}</td>
          	</tr>
          	<tr>     
	...
	<thead>
		...
		<tr><td >${cashless.getSno()}</td><td>${cashless.getReferenceType()}</td><td >${cashless.getTreatementType()}</td><td>${cashless.getWebsiteStatusVal()}</td><td >${cashless.getRequestedAmt()}</td><td>${cashless.getApprovedAmt()}</td>
...
<div class="row">
	...
	<!-- Below Billing Record no need for Retail Portal -->
	<%-- <div class="row">
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">
