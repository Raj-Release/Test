...
<div class="col-xs-6 col-md-6 col-lg-6">
		...
		<tbody>
			...
			<tr>     
				<td ><strong>Status of Cashless </strong></td>
               	<td>${preauth.getStatus().getPortalStatus()}</td>
          	</tr>
          	<tr>     
	...
	<thead>
		<tr><td ><strong>S.No</strong></td><td ><strong>Reference Number</strong></td><td ><strong>Treatment Type</strong></td><td ><strong>Status</strong></td><td ><strong>Requested Amount</strong></td><td ><strong>Approved Amount</strong></td>
		<td ><strong>Approval/Query/RejectLetter</strong></td>
		</tr>
		</thead>
		<tbody>
		<c:forEach items="${cashless}" var="cashless">
		
		<tr><td >${cashless.getSno()}</td><td>${cashless.getReferenceType()}</td><td >${cashless.getTreatementType()}</td><td>${cashless.getPortalStatusVal()}</td><td >${cashless.getRequestedAmt()}</td><td>${cashless.getApprovedAmt()}</td>
		
		<%-- <td><c:if test="${docAvailable ne false}"><form action = "ClaimStatusServlet" method="post"><a href="claimstatus?int_num=${intimation.getIntimationId()}&key=${cashless.getKey()}" target="_blank">View Letter</a></form></c:if></td> --%>
		<td><c:if test="${docAvailable ne false}"><form action = "ClaimStatusServlet" method="post"><a href="claimstatus?cashlessDoc=${cashless.getCashlessDocToken()}" target="_blank">View Letter</a></form></c:if></td>
		</tr>
		</c:forEach>
...
<div class="row">
	...
	<table class="table table-condensed table-bordered table-hover">
	 <thead>
		...
		<tr><td ><strong>Type</strong></td><td ><strong>ROD No</strong></td><td ><strong>Document Received From </strong></td><td ><strong>Document Received Date</strong></td><td ><strong>Medical Response Date & time</strong></td><td ><strong>Claimed Amount</strong></td><td ><strong>Mode of Receipt</strong></td>
		<td ><strong>Bill Classification</strong></td><td ><strong>Status</strong></td><td ><strong>Remarks</strong></td><td></td><td></td><td >View Query Letter</td><td >View Rejection Letter</td></tr>
		</thead>
		<tbody>
		<c:forEach items="${reimbursementList}" var="reimbursement">
		
		<tr><td>${reimbursement.getTypeOfClaim()}</td><td>${reimbursement.getReimbursementNo()}</td><td>${reimbursement.getDocumentReceivedFrom()}</td><td >${reimbursement.getDocumentReceivedDate()}</td><td >${reimbursement.getMedicalResponseDate()}</td><td >${reimbursement.getAmount()}</td><td >${reimbursement.getModeOfRececipt()}</td><td >${reimbursement.getBillClassification()}</td>
		<td >${reimbursement.getStatus()}</td><td >${reimbursement.getRemarks()}</td>
		...
		<%-- <td><form action = "ClaimStatusServlet" method="post"><a href="claimstatus?int_num=${intimation.getIntimationId()}&rod_num=${reimbursement.getReimbursementKey()}" target="_blank">View Rejection Details</a></form></td>
		<td><form action = "ClaimStatusServlet" method="post"><a href="claimstatus?intim_num=${intimation.getIntimationId()}&rod_num=${reimbursement.getReimbursementKey()}" target="_blank">View Query Details</a></form></td> --%>
		<td><form action = "ClaimStatusServlet" method="post"><a href="claimstatus?rejection=${reimbursement.getAcknowledgementToken()}" target="_blank">View Rejection Details</a></form></td>
		<td><form action = "ClaimStatusServlet" method="post"><a href="claimstatus?query=${reimbursement.getAcknowledgementToken()}" target="_blank">View Query Details</a></form></td>
		<td><form action = "ClaimStatusServlet" method="post"><a href="claimstatus?intimation_numb=${intimation.getIntimationId()}&rod_key=${reimbursement.getReimbursementKey()}&rod_num=${reimbursement.getReimbursementKey()}" target="_blank">View</a></form></td>
        <td><form action = "ClaimStatusServlet" method="post"><a href="claimstatus?rejection_intimation_numbr=${intimation.getIntimationId()}&rod_key=${reimbursement.getReimbursementKey()}&rod_num=${reimbursement.getReimbursementKey()}" target="_blank">View</a></form></td> </tr>
		</c:forEach>
		</tbody>
			</table>
			</div>
	...
	<thead>
		...
		<td><form action = "ClaimStatusServlet" method="post"><a href="claimstatus?billsummary=${item.getBillDtslToken()}" target="_blank">View Bill Summary</a></form></td>
	...
	<table class="table table-condensed table-bordered table-hover">
	<thead>
		<tr><td ><strong>S.No</strong></td><td ><strong>ROD No</strong></td><td ><strong>Claim Type</strong></td><td ><strong>Payee Name</strong><td ><strong>Payment Type</strong></td><td ><strong>Bank Name</strong></td>
		...
		<tr><td >${payment.getSerialNo()}</td><td >${payment.getRodNo()}</td><td>${payment.getClaimType()}</td><td>${payment.getPayeeName()}</td><td >${payment.getPaymentType()}</td><td >${payment.getBankName()}</td>
