...
<div class="col-xs-6 col-md-6 col-lg-6">
	...
	<thead>
		<tr><td ><strong>S.No</strong></td><td ><strong>Reference Type</strong></td><td ><strong>Response Date</strong></td><td ><strong>Status</strong></td><td ><strong>Treatment Type</strong></td><td ><strong>Requested Amount</strong></td><td ><strong>Approved Amount</strong></td>
		<td ><strong>Remarks</strong></td>
		</tr>
		</thead>
		<tbody>
		...
		<tr><td >${cashless.getSno()}</td><td>${cashless.getReferenceType()}</td><td >${cashless.getStrmodifiedDate()}</td><td>${cashless.getPortalStatusVal()}</td><td >${cashless.getTreatementType()}</td><td >${cashless.getRequestedAmt()}</td><td>${cashless.getApprovedAmt()}</td><td>${cashless.getRemarks()}</td>
...
<div class="row">
	...
	<table class="table table-condensed table-bordered table-hover">
	 <thead>
		...
		<td ><strong>Bill Classification</strong></td><td ><strong>Status</strong></td><td ><strong>Remarks</strong></td><td ></td><td ></td></tr>
		</thead>
		<tbody>
		<c:forEach items="${reimbursementList}" var="reimbursement">
		
		<tr><td>${reimbursement.getReimbursementNo()}</td><td>${reimbursement.getDocumentReceivedFrom()}</td><td >${reimbursement.getDocumentReceivedDate()}</td><td >${reimbursement.getMedicalResponseDate()}</td><td >${reimbursement.getAmount()}</td><td >${reimbursement.getModeOfRececipt()}</td><td >${reimbursement.getBillClassification()}</td>
	...
	<table class="table table-condensed table-bordered table-hover">
	<thead>
		<tr><td ><strong>S.No</strong></td><td ><strong>Type </strong></td><td ><strong>Billing Completed Date</strong></td><td ><strong>Bill Assessment Amount</strong></td><td ><strong>Status</strong></td>
		</tr>
		</thead>
		<tbody>
...
<%-- 	<div class="row">
	...
	<thead>
        ...
        <div class="col-xs-13">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <p class = "text-left"><strong>Financial Approval and Payment Details</strong></p>
                </div>
                <div class="panel-body">
                    <div class="table-responsive">
	<table class="table table-condensed table-bordered table-hover">
	<thead>
		<tr><td ><strong>S.No</strong></td><td ><strong>Document Received From</strong></td><td ><strong>Claim Type </strong></td><td ><strong>FA Date</strong></td><td ><strong>Approved Amount</strong></td><td ><strong>Status</strong></td>
		<td ><strong>Type Of Payment</strong></td><td ><strong>Cheque/Transaction No</strong></td><td ><strong>Cheque/Transaction-Date </strong></td><td ><strong>Payee Name</strong></td>
		<td ><strong>Bank Name</strong></td><td ><strong>Account No</strong></td><td ><strong>IFSC Code</strong></td><td ><strong>Branch Name</strong></td><td ><strong>FA Remarks</strong></td></tr>
		</thead>
		<tbody>
		<c:forEach items="${payment}" var="payment">
	
		<tr><td >${payment.getSerialNo()}</td><td >${payment.getDocReceivedFrom()}</td><td >${payment.getClaimType()}</td><td>${payment.getFaApprovalDateValue()}</td><td >${payment.getAmount()}</td><td >${payment.getPortalStatusVal()}</td>
		<td >${payment.getPaymentType()}</td><td >${payment.getChequeNo()}</td><td >${payment.getChequeDateValue()}</td><td>${payment.getPayeeName()}</td>
		<td >${payment.getBankName()}</td><td >${payment.getAccountNumber()}</td><td >${payment.getIfscCode()}</td><td >${payment.getBranchName()}</td><td>${payment.getFinancialRemarks()}</td></tr>
