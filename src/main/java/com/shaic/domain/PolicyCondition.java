...
@NamedQueries({
	...
	@NamedQuery(name="PolicyCondition.findByProduct", query = "SELECT m FROM PolicyCondition m where m.product.key = :productKey and m.activeStatus is not null and m.activeStatus = 1"),
