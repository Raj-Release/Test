...
@NamedQueries({
	...
	//@NamedQuery(name="GalaxyIntimationTable.findAll", query="SELECT o FROM GalaxyIntimationTable o where o.giSavedType <> :savedType and o.giHospitalTypeYn <> :hospType order by o.giCreatedOn desc "),
//	@NamedQuery(name="GalaxyIntimationTable.findAll", query="SELECT o FROM GalaxyIntimationTable o where o.giSavedType <> :savedType and o.giPACategory = :claimType order by o.giCreatedOn asc"),
	@NamedQuery(name="GalaxyIntimationTable.findAll", query="SELECT o FROM GalaxyIntimationTable o where o.giSavedType <> :savedType and o.giSavedType <> 'ERROR' and o.giHospitalTypeYn = '1' and o.productCode not in ('MED-PRD-047','ACC-PRD-008','MED-PRD-068') and o.giPolicyOwner = 'P' and o.giIntimationFlag = 'G' order by o.giCreatedOn asc"),
	@NamedQuery(name="GalaxyIntimationTable.findAllGmc", query="SELECT o FROM GalaxyIntimationTable o where o.giSavedType <> :savedType and o.giSavedType <> 'ERROR' and o.giHospitalTypeYn = '1' and o.productCode in ('MED-PRD-068','MED-PRD-047') and o.giPolicyOwner = 'P' and o.giIntimationFlag = 'G' order by o.giCreatedOn asc"),
	@NamedQuery(name="GalaxyIntimationTable.findByNonNetwork", query="SELECT o FROM GalaxyIntimationTable o where o.giSavedType <> :savedType and o.giSavedType <> 'ERROR' and o.giHospitalTypeYn = '0' and o.productCode <> 'ACC-PRD-008' and o.giPolicyOwner = 'P' and o.giIntimationFlag = 'G' order by o.giCreatedOn asc"),
	@NamedQuery(name="GalaxyIntimationTable.findByIntimationNumber", query="SELECT o FROM GalaxyIntimationTable o where o.giIntimationNo = :intimationNumber"),
	@NamedQuery(name="GalaxyIntimationTable.findByIntimationId", query="SELECT o FROM GalaxyIntimationTable o where o.giIntimationId = :intimationId"),
	@NamedQuery(name="GalaxyIntimationTable.findAllPa", query="SELECT o FROM GalaxyIntimationTable o where o.giSavedType <> :savedType and o.giSavedType <> 'ERROR' and o.productCode = 'ACC-PRD-008' and o.giPolicyOwner = 'P' and o.giIntimationFlag = 'G' order by o.giCreatedOn asc")
	
})

public class GalaxyIntimationTable extends AbstractEntity implements Serializable {
