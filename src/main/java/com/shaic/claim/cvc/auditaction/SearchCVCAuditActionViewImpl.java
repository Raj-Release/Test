 ...
 *
 */
public class SearchCVCAuditActionViewImpl extends AbstractMVPView implements SearchCVCAuditActionView{
	
	@Inject
	private SearchCVCAuditActionForm searchForm;
	
	@Inject
	private SearchCVCAuditActionTable searchResultTable;
...
private VerticalSplitPanel mainPanel;
	...
	public void resetSearchResultTableValues() {
		...
		while(componentIter.hasNext())
		{
			...
			if(comp instanceof SearchCVCAuditActionTable)
			{
				((SearchCVCAuditActionTable) comp).removeRow();
			}
		}
		...
		}else
		{
			...
			homeButton.addClickListener(new Button.ClickListener() {
				...
				public void buttonClick(ClickEvent event) {
					dialog.close();
					fireViewEvent(MenuItemBean.CVC_AUDIT_ACTION_PROCESSING, null);
	...
	public void doSearch() {
		...
		fireViewEvent(SearchCVCAuditActionPresenter.SUBMIT_SEARCH, searchDTO,userName,passWord);
	...
	public void init(){
		...
		fireViewEvent(SearchCVCAuditActionPresenter.GET_AUDIT_USER_CLM_TYPE, userName);
