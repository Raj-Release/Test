 ...
 *
 */
@ViewInterface(CVCAuditActionPageView.class)
public class CVCAuditActionPagePresenter extends AbstractMVPPresenter<CVCAuditActionPageView>{
	...
	public static final String SUBMIT_EVENT_AUDIT_ACTION = "Submit event for CVC Audit Action";
	
	public static final String LOAD_CVC_AUDIT_ACTION_STATUS_VALUES = "load_cvc_audit_action_status_values";
	...
	public static final String CANCEL_EVENT_AUDIT_ACTION = "Cancel event for CVC Audit Action";
	...
	@EJB
	private SearchCVCAuditActionService cvcSearchService;
	...
	public void submitEvent(
			@Observes @CDIEvent(SUBMIT_EVENT_AUDIT_ACTION) final ParameterDTO parameters) {
