...
//		HorizontalLayout intimationLayout = new HorizontalLayout(txtIntimationNumber,txtReason,pickBtn); 
		VerticalLayout layout1 = new VerticalLayout(concurrentCashessSearchBtn,nonConcurrentCashessSearchBtn,hospitalStlmntSearchBtn,txtIntimationNumber);
		layout1.setSizeFull();
		...
		HorizontalLayout finalLayout = new HorizontalLayout(layout1,layout2,layout3);
