...
import com.shaic.claim.processdatacorrection.search.TreatingCorrectionTabel.ImmediateFieldFactory;
...
public class ActualTreatingCorrectionTabel extends ViewComponent{
	...
	void initTable(VerticalLayout layout){
		...
		table.setVisibleColumns(new Object[] { "actualtreatingDoctorName","actualqualification","Delete"});
		...
		if(correctionDTOs !=null && !correctionDTOs.isEmpty()){
			for(TreatingCorrectionDTO treatingCorrectionDTO:correctionDTOs){
				if(treatingCorrectionDTO.getActualtreatingDoctorName() !=null
					...
					hasError = true;
					errorMessages.add("enter Actual Qualification");
					...
					hasError = true;
					errorMessages.add("enter Actual DoctorName");
				}
			}
		}
		return !hasError;
