...
public class ViewActualImplantCorrectionTabel extends GBaseTable<ImplantCorrectionDTO>{
	...
	public void initTable() {
		...
		Object[] VISIBLE_COLUMNS = new Object[] {"serialNumber","actualImplantName","actualImplantType","actualImplantCost"};
