...
public class ViewSpecialityCorrectionTable extends GBaseTable<SpecialityCorrectionDTO>{
	...
	public void initTable() {
		...
		Object[] VISIBLE_COLUMNS = new Object[] {"serialNumber","specialityType","procedure","remarks"};
	...
	public String textBundlePrefixString() {
		// TODO Auto-generated method stub
		return "view-speciality-correction-table-";
	}
}
