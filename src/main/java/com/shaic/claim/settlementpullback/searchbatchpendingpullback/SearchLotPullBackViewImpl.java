...
public class SearchLotPullBackViewImpl extends AbstractMVPView implements SearchLotPullBackView{
	...
	@Inject
	private SearchLotPullBackForm searchForm;
	
	@Inject
	private SearchLotPullBackTable searchResultTable;
	...
	public void doSearch() {
		...
		if(searchForm.validatePage()){
			SearchLotPullBackFormDTO searchDTO = searchForm.getSearchDTO();
			...
			fireViewEvent(SearchLotPullBackPresenter.SEARCH_BUTTON_CLICK, searchDTO,userName,passWord);
			} else {
	...
	public void resetSearchResultTableValues() {
		...
		while(componentIter.hasNext())
		{
			...
			if(comp instanceof SearchLotPullBackTable)
			{
				((SearchLotPullBackTable) comp).removeRow();
			}
		}
	}
	...
	@Override
	public void list(Page<SearchLotPullBackTableDTO> tableRows) {
