...
import com.shaic.claim.processdatacorrection.search.ActualDiganosisCorrectionTable;
import com.shaic.claim.processdatacorrection.search.ActualProcedureCorrectionTable;
import com.shaic.claim.processdatacorrection.search.ActualSpecialityCorrectionTable;
import com.shaic.claim.processdatacorrection.search.ActualTreatingCorrectionTabel;
import com.shaic.claim.processdatacorrection.search.DiganosisCorrectionDTO;
import com.shaic.claim.processdatacorrection.search.DiganosisCorrectionTable;
...
import com.shaic.claim.processdatacorrection.search.ProcedureCorrectionTable;
...
import com.shaic.claim.processdatacorrection.search.SpecialityCorrectionTable;
import com.shaic.claim.processdatacorrection.search.TreatingCorrectionDTO;
import com.shaic.claim.processdatacorrection.search.TreatingCorrectionTabel;
...
public class DataCorrectionHistoricalViewImpl extends AbstractMVPView implements DataCorrectionHistoricalView {
	...
	public void initView(ProcessDataCorrectionDTO bean) {
		...
		if(bean.getTreatmentType() !=null && 
			...
			tableLayout = new VerticalLayout(specialityCorrectionObj,actualSpecialityObj,diganosisCorrectionObj,actualdiganosisObj,procedureCorrectionObj,actualprocedureObj,treatingCorrectionObj,actualtreatingObj,scoringHLayout,remarkHLayout);
		}else{
