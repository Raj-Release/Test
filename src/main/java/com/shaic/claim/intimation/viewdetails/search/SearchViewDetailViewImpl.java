...
public class SearchViewDetailViewImpl extends AbstractMVPView implements SearchViewDetailView{
	
	@EJB
	IntimationService intimationservice;
	
	@Inject
	private Instance<SearchViewDetailUI> searchIntimation;

	@Inject
	private SearchViewDetailIntimationTable searchResultTable;
...
//		     Page<NewIntimationDto> newIntimationDtoPagedContainer = intimationservice.searchCombinationforViewAndEdit(params);
	...
	private void noRecordFound(){
		...
		homeButton.addClickListener(new ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				dialog.close();
				fireViewEvent(MenuItemBean.INTIMATION_VIEW_DETAILS, null);
	...
	public void doSearch() {
		...
		Page<NewIntimationDto> newIntimationDtoPagedContainer = intimationservice.searchCombinationforView(searchDto);
...
//			 VerticalSplitPanel mainPanel = searchIntimation.get().getMainPanel();
