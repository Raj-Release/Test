...
public class ViewTopUpPolicyDetailsForGMC extends ViewComponent{
    ...
    public void init(List<PreauthDTO> topupData, PreauthDTO bean, String screenName, Window popup){
			...
			homeButton.addClickListener(new ClickListener() {
				...
				public void buttonClick(ClickEvent event) {
					...
					if(screenName.equalsIgnoreCase(SHAConstants.PRE_AUTH)){
						...
						fireViewEvent(ClaimRequestMedicalDecisionPagePresenter.MA_TOPUP_POLICY_INTIMATION_EVENT, bean, topupData,riskId);
					}
