...
@ViewInterface(DownsizePreauthRequestWizard.class)
public class DownsizePreauthRequestWizardPresenter extends AbstractMVPPresenter<DownsizePreauthRequestWizard> {
...
/**
	...
	public static final String DOWNSIZE_STEP_CHANGE_EVENT = "downsize_preauth_request_step_change_event";
	
	public static final String GET_EXCLUSION_DETAILS = "downsize_preauth_request_get_exclusion_details";
	
	public static final String SUM_INSURED_CALCULATION="Sum insured calculation for downsize preauth request ";
	
	public static final String SET_DOWNSIZE_AMOUNT="Set downsize amount for downsize preauth request";
	
	public static final String DOWNSIZE_SUBMIT_EVENT="submit for downsize preauth request";
	
	public static final String GET_HOSPITALIZATION_DETAILS = "Downsize_preauth_request_get_hospitalization_details";
	
	public static final String BALANCE_SUM_INSURED = "downsize_preauth_request_balance_sum_insured";
	
	public static final String VALIDATE_DOWNSIZE_PREAUTH_REQUEST_USER_RRC_REQUEST = "downsize_preauth_request_user_rrc_request";
	
	public static final String DOWNSZIE_PREAUTH_REQUEST_LOAD_RRC_REQUEST_DROP_DOWN_VALUES = "downsize_preauth_request_load_rrc_request_drop_down_values";
	
	public static final String DOWNSIZE_PREAUTH_REQUEST_SAVE_RRC_REQUEST_VALUES = "downsize_preauth_request_save_rrc_request_values";
	
	public static final String NEGOTIATION_CANCEL_OR_UPDATE = "downsize_request_negotiation cancel";
	
	public static final String GET_DOWNSIZE_REMARKS_RETAIL = "get Downsize Remarks Standalone";
	
	public static final String PREV_PREAUTH_APPROVED_DATE = "GET PREV PREAUTH APPROVED DATE STANDALONE REQ";
	
	public static final String DOWNSZIE_PREAUTH_REQUEST_LOAD_RRC_REQUEST_SUB_CATEGORY_VALUES = "downszie_preauth_request_load_rrc_request_sub_category_values";
	
	public static final String DOWNSZIE_PREAUTH_REQUEST_LOAD_RRC_REQUEST_SOURCE_VALUES = "downszie_preauth_request_load_rrc_request_source_values";
...
//				R1135    -     13-04-2018
	...
	public void getDownSizeRemarks(@Observes @CDIEvent(GET_DOWNSIZE_REMARKS_RETAIL) final ParameterDTO parameters)
	{		
		Long downSizeReasonId = (Long) parameters.getPrimaryParameter();
		
		MasterRemarks remarks = masterService.getRemarks(downSizeReasonId);

		view.setdownsizeRemarks(remarks);
	...
	public void previousPreauthApporvedDate(@Observes @CDIEvent(PREV_PREAUTH_APPROVED_DATE) final ParameterDTO parameters) {
	...
	public void setUpSubCategoryValues(
			@Observes @CDIEvent(DOWNSZIE_PREAUTH_REQUEST_LOAD_RRC_REQUEST_SUB_CATEGORY_VALUES) final ParameterDTO parameters) {
	...
	public void setUpsourceValues(
			@Observes @CDIEvent(DOWNSZIE_PREAUTH_REQUEST_LOAD_RRC_REQUEST_SOURCE_VALUES) final ParameterDTO parameters) {
