...
public class AllocateCorpBufferPresenter extends AbstractMVPPresenter<AllocateCorpBufferView> {
	...
	public void submitDetails(@Observes @CDIEvent(SUBMIT_BUTTON_CLICK) final ParameterDTO parameters) {
		Double sumInsured = (Double) parameters.getPrimaryParameter();
		AllocateCorpBufferDetailDTO corpBufferDto = (AllocateCorpBufferDetailDTO)parameters.getSecondaryParameter(0, AllocateCorpBufferDetailDTO.class);
		searchService.updateCorpBufferLimit(sumInsured, corpBufferDto);
	}
