...
public class DiagnosisDetailsTableDTO extends AbstractTableDTO {
	/**
	 * 
	 */
...
//	@NotNull(message = "Please Select ICD Block")
	...
	@NotNull(message = "Please Select Insurance Diagnosis")
...
//	@NotNull(message = "Please Select Consider For Payment")  CR R20181300
	private SelectValue considerForPayment;
	
	private SelectValue pedImpactOnDiagnosis;
    ...
    private boolean sublimitMapAvailable;
    
    private Long sublimitNameKey;
    
    private String icdsublimitMapName;
    
	private SelectValue oldIcdCode;
	
	private SelectValue oldDiagnosisId;
	...
	private String primaryDiagnosisFlag;

	public DiagnosisDetailsTableDTO(){
    	
    }

    public DiagnosisDetailsTableDTO(String presenterString){
	...
	private SublimitFunObject oldSublimitName;
	...
	public void setConsiderForPaymentFlag(String considerForPaymentFlag) {
		...
		this.considerForPayment.setId((this.considerForPaymentFlag != null && this.considerForPaymentFlag.equalsIgnoreCase("Y")) ? ReferenceTable.COMMONMASTER_YES : (this.considerForPaymentFlag != null && this.considerForPaymentFlag.equalsIgnoreCase("N")) ? ReferenceTable.COMMONMASTER_NO : 0l);
	}
...
//		
    ...
    public boolean equals(Object obj) {
        if (obj == null || !getClass().isAssignableFrom(obj.getClass())) {
            ...
            return ((getPedId().equals(((DiagnosisDetailsTableDTO) obj).getPedId())) && (getDummyKey().equals(((DiagnosisDetailsTableDTO) obj).getDummyKey())));  
        } else {
        	return getPedId().equals(((DiagnosisDetailsTableDTO) obj).getDummyKey());
        }
    }
	...
	public boolean isSublimitMapAvailable() {
		return sublimitMapAvailable;
	}

	public void setSublimitMapAvailable(boolean sublimitMapAvailable) {
		this.sublimitMapAvailable = sublimitMapAvailable;
	}

	public Long getSublimitNameKey() {
		return sublimitNameKey;
	}

	public void setSublimitNameKey(Long sublimitNameKey) {
		this.sublimitNameKey = sublimitNameKey;
	}
	...
	public SelectValue getPedImpactOnDiagnosis() {
		return pedImpactOnDiagnosis;
	}

	public void setPedImpactOnDiagnosis(SelectValue pedImpactOnDiagnosis) {
	...
	public SublimitFunObject getOldSublimitName() {
		return oldSublimitName;
	}

	public void setOldSublimitName(SublimitFunObject oldSublimitName) {
		this.oldSublimitName = oldSublimitName;
	}

	public SelectValue getOldIcdCode() {
		return oldIcdCode;
	}

	public void setOldIcdCode(SelectValue oldIcdCode) {
		this.oldIcdCode = oldIcdCode;
	}

	public SelectValue getOldDiagnosisId() {
		return oldDiagnosisId;
	}

	public void setOldDiagnosisId(SelectValue oldDiagnosisId) {
	...
	public void setPrimaryDiagnosis(Boolean primaryDiagnosis) {
		if(primaryDiagnosis!=null && primaryDiagnosis ){
			this.primaryDiagnosisFlag = SHAConstants.YES_FLAG;
		}else{
			this.primaryDiagnosisFlag = SHAConstants.N_FLAG;
		}
		this.primaryDiagnosis = primaryDiagnosis;
	}

	public String getPrimaryDiagnosisFlag() {
		return primaryDiagnosisFlag;
	}

	public void setPrimaryDiagnosisFlag(String primaryDiagnosisFlag) {
		if(primaryDiagnosisFlag != null){
			if(primaryDiagnosisFlag.equalsIgnoreCase(SHAConstants.YES_FLAG)){
				this.primaryDiagnosis = Boolean.TRUE;
			}else{
				this.primaryDiagnosis = Boolean.FALSE;
			}
		}
		this.primaryDiagnosisFlag = primaryDiagnosisFlag;
	}
