...
public class ProcedureListenerTableForPremedical extends ViewComponent {
		    	...
		    	deleteButton.addClickListener(new Button.ClickListener() {
					...
					public void buttonClick(ClickEvent event) {
			        	...
			        	//	dialog.setClosable(false);
							...
							GalaxyAlertBox.createErrorBox("One Procedure is Mandatory.", buttonsNamewithType);
			        	}
	...
	public class ImmediateFieldFactory extends DefaultFieldFactory {
		...
		public Field<?> createField(Container container, Object itemId,
			...
			if("procedureName".equals(propertyId)) {
				...
				setEnableOrDisableSection(box,procedureDTO);	
				return box;
					...
					public void componentEvent(Event event) {
						...
						if(null != selectValue && null != selectValue.getValue())
						{
							...
							if(count > 1) {
				        		...
				        		HashMap<String, String> buttonsNamewithType = new HashMap<String, String>();
								buttonsNamewithType.put(GalaxyButtonTypesEnum.OK.toString(), "OK");
								GalaxyAlertBox.createWarningBox("Duplicate Procedure is not allowed. Please choose different Procedure", buttonsNamewithType);
				        		component.setValue(null);
							...
							{								
								...
								{	
									if(strProcValue.equalsIgnoreCase(strDiagName))
									{
						        		...
						        		HashMap<String, String> buttonsNamewithType = new HashMap<String, String>();
										buttonsNamewithType.put(GalaxyButtonTypesEnum.OK.toString(), "OK");
										GalaxyAlertBox.createErrorBox("Diagnosis and Procedure are same.", buttonsNamewithType);
//						        		dialog.show(getUI().getCurrent(), null, true);
...
//						}
	...
	public void setPackageRate(Map<String, String> values) {
		if(values.get("packageRate")!=null){
	...
	private void setPackageRateAndDayCareProcedure(Long procedureKey,String procedureCode,TextField packageRate, TextField dayCareProcedure, ComboBox procedureCodeCombo) {
		if("premedicalPreauth".equalsIgnoreCase(this.presenterString)) {
			...
			fireViewEvent(PAClaimRequestDataExtractionPagePresenter.GET_PACKAGE_RATE,procedureKey,hospitalCode,bean);
			...
			if(bean.getSublimitApplicable() != null && bean.getSublimitApplicable().getId().equals(ReferenceTable.COMMONMASTER_YES) && bean.getSublimitName() == null) {
				...
				if(sublimtName != null && sublimtName.getValue() != null){
					...
					if(sublimtNameValue != null && (sublimtNameValue.getName() == null || (sublimtNameValue.getName() != null && sublimtNameValue.getName().isEmpty()))){
						hasError = true;
						errorMessages.add("Please Select Sublimit Name in Procedure Table");
					}
				}
			}
		    	...
		    	deleteButton.addClickListener(new Button.ClickListener() {
					...
					public void buttonClick(ClickEvent event) {
			        	...
			        	if(table.getItemIds().size() > 0) {
			        		...
			        		HashMap<String, String> buttonsNamewithType = new HashMap<String, String>();
							buttonsNamewithType.put(GalaxyButtonTypesEnum.OK.toString(), "OK");
							GalaxyAlertBox.createErrorBox("One Diagnosis is Mandatory.", buttonsNamewithType);
			        	}
			        } 
			    });
		    	deleteButton.addStyleName(ValoTheme.BUTTON_DANGER);
...
//			}
	...
	public void setEnableOrDisableSection(GComboBox box, ProcedureDTO procedureDto)
	{
	if(null != bean.getNewIntimationDTO().getPolicy().getProduct().getKey() &&
		...
		(ReferenceTable.STAR_CARDIAC_CARE_NEW.equals(bean.getNewIntimationDTO().getPolicy().getProduct().getKey()))){
			...
			if(null != bean.getPreauthDataExtractionDetails().getSection().getId() &&
