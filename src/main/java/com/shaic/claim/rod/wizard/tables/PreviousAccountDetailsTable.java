...
public class PreviousAccountDetailsTable extends GBaseTable<PreviousAccountDetailsDTO>{
	...
	private final static Object[] NATURAL_COL_ORDER = new Object[]{"serialNo","chkSelect","source","policyClaimNo","receiptDate", "bankAccountNo", "bankName", "bankCity","bankBranch","accountType",
		"ifsccode"} ;
