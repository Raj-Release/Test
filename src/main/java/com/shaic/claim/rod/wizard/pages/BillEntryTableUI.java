...
import com.shaic.claim.rod.wizard.tables.BillReviewListenerTable;
...
public class BillEntryTableUI extends ViewComponent {
	
	@Inject
	private BillEntryListenerTable billEntryTable;
	
	@Inject
	private BillReviewListenerTable billReviewTable;
...
//                     	  byte[] byteChunk = new byte[100000]; // Or whatever size you want to read in at a time.
	   ...
	   /* hsplitPanel.addComponent(imagePanel);
		 ...
		 * */
		if(null != presenterString && !("").equalsIgnoreCase(presenterString) && ((SHAConstants.ZONAL_REVIEW).equalsIgnoreCase(presenterString) || (SHAConstants.BILLING).equalsIgnoreCase(presenterString) || (SHAConstants.WITHDRAW_CASHLESS).equalsIgnoreCase(presenterString)
				|| (SHAConstants.FINANCIAL).equalsIgnoreCase(presenterString) ||  (SHAConstants.CLAIM_REQUEST).equalsIgnoreCase(presenterString) || (SHAConstants.PA_PROCESS_CLAIM_REQUEST).equalsIgnoreCase(presenterString)))
		{
			...
			if((SHAConstants.BILLING).equalsIgnoreCase(presenterString) ||  (SHAConstants.FINANCIAL).equalsIgnoreCase(presenterString) || (SHAConstants.WITHDRAW_CASHLESS).equalsIgnoreCase(presenterString))
			{
...
//			txtCorporateRemarks.setWidth("400px");
			...
			if(txtCorporateRemarks!= null && txtCorporateRemarks.getValue()==null ){
...
//										
	...
	private void setTableValues()
	{
		...
		if(null != presenterString && !("").equalsIgnoreCase(presenterString) && ((SHAConstants.ZONAL_REVIEW).equalsIgnoreCase(presenterString) || (SHAConstants.BILLING).equalsIgnoreCase(presenterString) 
				|| (SHAConstants.FINANCIAL).equalsIgnoreCase(presenterString) || (SHAConstants.CLAIM_REQUEST).equalsIgnoreCase(presenterString) || (SHAConstants.PA_PROCESS_CLAIM_REQUEST).equalsIgnoreCase(presenterString) || (SHAConstants.WITHDRAW_CASHLESS).equalsIgnoreCase(presenterString)))
		{
			...
			if(null != billEntryTable)
			{
				...
				if(null != billEntryList && !billEntryList.isEmpty())
				{
					for (BillEntryDetailsDTO billEntryDetailsDTO : billEntryList) {
						...
						if(null != presenterString && !("").equalsIgnoreCase(presenterString) && ((SHAConstants.PA_BILL_ENTRY).equalsIgnoreCase(presenterString)))
						{
							billEntryDetailsDTO.setClassification(billEntryDetailsDTO.getClassification());
						}
						else if(!(null != bean.getHospitalizationId() && null != billEntryDetailsDTO.getClassification() && bean.getHospitalizationId().equals(billEntryDetailsDTO.getClassification().getId())
								||  (null != bean.getPreHospitalizationId() && null != billEntryDetailsDTO.getClassification() && bean.getPreHospitalizationId().equals(billEntryDetailsDTO.getClassification().getId()))
								||  null != bean.getPostHospitalizationId() && null != billEntryDetailsDTO.getClassification() && bean.getPostHospitalizationId().equals(billEntryDetailsDTO.getClassification().getId())
								||  null != bean.getLumpsumId() && null != billEntryDetailsDTO.getClassification() && bean.getLumpsumId().equals(billEntryDetailsDTO.getClassification().getId())
								||  null != bean.getOtherBenefitsId() && null != billEntryDetailsDTO.getClassification() && bean.getOtherBenefitsId().equals(billEntryDetailsDTO.getClassification().getId())))
						{
							billEntryDetailsDTO.setClassification(null);
						}						
	...
	private void billEntryStatusListener()
	{
		optBillEntryStatus.addValueChangeListener(new Property.ValueChangeListener() {
			...
			//public void componentEvent(Event event) {
				...
				{
					if(getUI().getCurrent().getPage().getWebBrowser().isIE()){
						if(event.getProperty().getValue()!=null&&event.getProperty().getValue().equals(Boolean.TRUE)||event.getProperty().getValue().equals(Boolean.FALSE)
								&& ((bean.getFileName() != null && bean.getFileName().endsWith(".PDF")) || (bean.getFileName() != null && bean.getFileName().endsWith(".pdf")))){
							e.setVisible(false);
						}
					}
						 ...
						 else
						 {
										...
										|| (SHAConstants.FINANCIAL).equalsIgnoreCase(presenterString) || (SHAConstants.CLAIM_REQUEST).equalsIgnoreCase(presenterString))) 
							 {
								 ...
								 if((SHAConstants.ZONAL_REVIEW).equalsIgnoreCase(presenterString)){
									 ...
									 bean.setBillDate(txtBillDate.getValue());
									 bean.setBillNo(txtBillNo.getValue());
									 buildSuccessLayout("Bill Entry Verified in WithDrawn Cashless. </br> Click OK to proceed , or cancel to stay back",totalBillValue,totalNetAmt);
								 }
	...
	private void billEntrySaveListener()
	{
		optSaveBillEntryDetails.addClickListener(new ClickListener() {
			...
			public void buttonClick(ClickEvent event) {	
				...
				if(getUI().getCurrent().getPage().getWebBrowser().isIE()){
					if(((bean.getFileName() != null && bean.getFileName().endsWith(".PDF")) || (bean.getFileName() != null && bean.getFileName().endsWith(".pdf")))){
						e.setVisible(false);
					}
				}
			//public void componentEvent(Event event) {
...
//			dialog.show(getUI().getCurrent(), null, true);
			...
			homeButton.addClickListener(new ClickListener() {
				...
				public void buttonClick(ClickEvent event) {					
					...
					{
						fireViewEvent(ClaimRequestMedicalDecisionPagePresenter.BILL_ENTRY_COMPLETION_STATUS, bean);
					}
					else if((SHAConstants.BILLING).equalsIgnoreCase(presenterString))
					{
						fireViewEvent(BillingReviewPagePresenter.BILL_ENTRY_COMPLETION_STATUS, bean);
					}
					else if((SHAConstants.FINANCIAL).equalsIgnoreCase(presenterString))
					{
						fireViewEvent(FinancialReviewPagePresenter.BILL_ENTRY_COMPLETION_STATUS, bean);
					}
					...
					{
						fireViewEvent(WithdrawPreauthPostProcessWizardPresenter.BILL_ENTRY_SUBMIT_STATUS, bean);
					}
...
//			dialog.show(getUI().getCurrent(), null, true);
			...
			buttonsNamewithType.put(GalaxyButtonTypesEnum.OK.toString(), "OK");
			HashMap<String, Button> messageBoxButtons = GalaxyAlertBox
					.createInformationBox("<b style = 'color: green;'> "+ message, buttonsNamewithType);
			Button homeButton = messageBoxButtons.get(GalaxyButtonTypesEnum.OK
					.toString());
			...
			homeButton.addClickListener(new ClickListener() {
				...
				public void buttonClick(ClickEvent event) {					
					...
					{
						fireViewEvent(ClaimRequestMedicalDecisionPagePresenter.MA_SAVE_BILL_ENTRY_VALUES, bean);
					}
					else if((SHAConstants.BILLING).equalsIgnoreCase(presenterString))
					{
						fireViewEvent(BillingReviewPagePresenter.BILLING_SAVE_BILL_ENTRY_VALUES, bean);
					}
					else if((SHAConstants.FINANCIAL).equalsIgnoreCase(presenterString))
					{
						fireViewEvent(FinancialReviewPagePresenter.FA_SAVE_BILL_ENTRY_VALUES, bean);
					}
					else if(SHAConstants.ADD_ADDITIONAL_DOCS.equalsIgnoreCase(presenterString)){
		...
		if(null != this.billEntryTable)
		{
			...
			if(null != billEntryDetailsList && !billEntryDetailsList.isEmpty())
			{
				for (BillEntryDetailsDTO billEntryDetailsDTO : billEntryDetailsList) {
					...
					{
 						hasError = true;
						eMsg.append("Please choose bill classification for item no ").append(" ").append(billEntryDetailsDTO.getItemNo()).append("</br>");
						break;
					...
					{
						hasError = true;
						eMsg.append("Please enter item name for item no ").append(" ").append(billEntryDetailsDTO.getItemNo()).append("</br>");
						break;
					}
					...
					{
						hasError = true;
						eMsg.append("Please choose bill category for item no ").append(" ").append(billEntryDetailsDTO.getItemNo()).append("</br>");
						break;
					}
					...
					{
						hasError = true;
						eMsg.append("Reasonable Deductable Amount should not be greater than Zero in Item").append(" ").append(billEntryDetailsDTO.getItemNo()).append("</br>");
						break;
					}
					...
					{
						hasError = true;
						eMsg.append("Please enter no of days and per day amount , if category is Room Rent or ICU Rooms for item no ").append(" ").append(billEntryDetailsDTO.getItemNo()).append("</br>");
						break;
					}
					...
					{
						hasError = true;
						eMsg.append("Please enter no of days and per day amount , if category is ICU Nursing Charges  or Nursing Charges for item no ").append(" ").append(billEntryDetailsDTO.getItemNo()).append("</br>");
						break;
					}
					...
					{
						hasError = true;
						eMsg.append("Please enter item value  for item no ").append(" ").append(billEntryDetailsDTO.getItemNo()).append("</br>");
						break;
					}
					}
							...
							|| (SHAConstants.FINANCIAL).equalsIgnoreCase(presenterString) || (SHAConstants.CLAIM_REQUEST).equalsIgnoreCase(presenterString) || (SHAConstants.PA_PROCESS_CLAIM_REQUEST).equalsIgnoreCase(presenterString)))
					{
						...
						{
							hasError = true;
							eMsg.append("Please enter no of days allowed and per day amount , if category is Room Rent or ICU Rooms for item no ").append(" ").append(billEntryDetailsDTO.getItemNo()).append("</br>");
							break;
						}
						
						if(null != billEntryDetailsDTO.getCategory() &&  null == billEntryDetailsDTO.getItemValue() && !((SHAConstants.DEDUCTIBLES).equalsIgnoreCase(billEntryDetailsDTO.getCategory().getValue().trim()) || null != billEntryDetailsDTO.getCategory() &&  (SHAConstants.DEDUCTIBLES_80_PERCENT).equalsIgnoreCase(billEntryDetailsDTO.getCategory().getValue().trim())))
				{
					hasError = true;
					eMsg.append("Please enter item value  </br>");
					break;
				}
						...
						if ( (null != billEntryDetailsDTO.getReasonableDeduction() || null != billEntryDetailsDTO.getNonPayable()) && ((null == billEntryDetailsDTO.getDeductibleOrNonPayableReason() || ("").equalsIgnoreCase(billEntryDetailsDTO.getDeductibleOrNonPayableReason()))
								&& null != billEntryDetailsDTO.getCategory() &&  (("Deductibles").equalsIgnoreCase(billEntryDetailsDTO.getCategory().getValue().trim()) || ("Deductibles (80%)").equalsIgnoreCase(billEntryDetailsDTO.getCategory().getValue().trim())
								|| null != billEntryDetailsDTO.getCategory() &&  ("Hospital Discount").equalsIgnoreCase(billEntryDetailsDTO.getCategory().getValue().trim()))))
						{
							hasError = true;
							eMsg.append("Please enter deductible or non payable reason</br>");
							break;
						}
						...
						if(null != billEntryDetailsDTO.getItemValue() && null != billEntryDetailsDTO.getTotalDisallowances())
						{
							if(billEntryDetailsDTO.getTotalDisallowances() > billEntryDetailsDTO.getItemValue())
							{
								...
								eMsg.append("In Item no. "+billEntryDetailsDTO.getItemNo()).append(" ,Total Disallowances should not exceed claimed amount value</br>");
								break;
							}
						}
						...
						if(null != presenterString && !("").equalsIgnoreCase(presenterString) && ((SHAConstants.FINANCIAL).equalsIgnoreCase(presenterString) || (SHAConstants.BILLING).equalsIgnoreCase(presenterString) || (SHAConstants.PA_PROCESS_CLAIM_REQUEST).equalsIgnoreCase(presenterString)))
						{
							...
							{
								hasError = true;
								eMsg.append("Please select IRDA level1 for item no ").append(" ").append(billEntryDetailsDTO.getItemNo()).append("</br>");
								break;
							}
							if(!(null != billEntryDetailsDTO.getIrdaLevel2() && !("").equalsIgnoreCase(billEntryDetailsDTO.getIrdaLevel2().getValue())))
							{
								hasError = true;
								eMsg.append("Please select IRDA level2 for item no ").append(" ").append(billEntryDetailsDTO.getItemNo()).append("</br>");
								break;
							}
							
							if(null != billEntryDetailsDTO.getCategory() && null != billEntryDetailsDTO.getCategory().getValue() &&  null == billEntryDetailsDTO.getDeductibleOrNonPayableReason() && !("Deductibles").equalsIgnoreCase(billEntryDetailsDTO.getCategory().getValue().trim()) && !("Deductibles (80%)").equalsIgnoreCase(billEntryDetailsDTO.getCategory().getValue().trim())
									&& !("Hospital Discount").equalsIgnoreCase(billEntryDetailsDTO.getCategory().getValue().trim()))
							{
								/**
...
//							}
						...
						//IMSSUPPOR-27134
					if(billEntryDetailsDTO.getCategory()!=null && billEntryDetailsDTO.getCategory().getValue()!=null && (("Deductibles").equalsIgnoreCase(billEntryDetailsDTO.getCategory().getValue().trim()) || ("Deductibles(80%)").equalsIgnoreCase(billEntryDetailsDTO.getCategory().getValue().trim()))
                                && billEntryDetailsDTO.getNonPayable()==null){
                       hasError = true;
                       eMsg.append("Please enter non payable amount for Deductibles.").append("</br>");
                       break;
						}
			...
			{
				hasError = true;
				eMsg.append("Please enter bill details</br>");
			}
			...
			if(null != presenterString && (SHAConstants.ZONAL_REVIEW).equalsIgnoreCase(presenterString)){
				if(txtZonalRemarks != null && ("").equalsIgnoreCase(txtZonalRemarks.getValue()) || null == txtZonalRemarks.getValue()){
					hasError = true;
					eMsg.append( "Please Enter Zonal Remarks </br>");
				}
			}
			...
			if(null != presenterString && ((SHAConstants.CLAIM_REQUEST).equalsIgnoreCase(presenterString) || (SHAConstants.PA_PROCESS_CLAIM_REQUEST).equalsIgnoreCase(presenterString))){
				if(txtCorporateRemarks != null && ("").equalsIgnoreCase(txtCorporateRemarks.getValue()) || null == txtCorporateRemarks.getValue()){
					hasError = true;
					eMsg.append("Please Enter Corporate Remarks </br>");
				}
			}
			...
			if(null != presenterString && (SHAConstants.BILLING).equalsIgnoreCase(presenterString)){
				if(billingRemarks != null && ("").equalsIgnoreCase(billingRemarks.getValue()) || null == billingRemarks.getValue()){
					hasError = true;
					eMsg.append("Please Enter Billing Remarks </br>");
				}
			}
...
//				dialog.show(getUI().getCurrent(), null, true);
				...
				buttonsNamewithType.put(GalaxyButtonTypesEnum.OK.toString(), "OK");
				HashMap<String, Button> messageBoxButtons = GalaxyAlertBox
						.createErrorBox(eMsg.toString(), buttonsNamewithType);
				Button homeButton = messageBoxButtons.get(GalaxyButtonTypesEnum.OK
						.toString());
				homeButton.addClickListener(new ClickListener() {
					private static final long serialVersionUID = 7396240433865727954L;
	...
	public ShortcutListener setShortcuts(){
		if(null != presenterString && !("").equalsIgnoreCase(presenterString) && ((SHAConstants.ZONAL_REVIEW).equalsIgnoreCase(presenterString) || (SHAConstants.BILLING).equalsIgnoreCase(presenterString) || (SHAConstants.WITHDRAW_CASHLESS).equalsIgnoreCase(presenterString)
				|| (SHAConstants.FINANCIAL).equalsIgnoreCase(presenterString) ||  (SHAConstants.CLAIM_REQUEST).equalsIgnoreCase(presenterString) || (SHAConstants.PA_PROCESS_CLAIM_REQUEST).equalsIgnoreCase(presenterString)))
		{
			return billReviewTable.addButtonShortCut();
		}else{
			return billEntryTable.addButtonShortCut();
		}
	}
