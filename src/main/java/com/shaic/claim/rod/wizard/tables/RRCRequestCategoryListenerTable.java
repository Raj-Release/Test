...
public class RRCRequestCategoryListenerTable extends ViewComponent {
	...
	void initTable() {
		...
		table.setVisibleColumns(new Object[] { "slNo", "category","subCategory","sourceOfIdentification"});
	...
	public void addCategoryValues(ComboBox comboBox) {
		BeanItemContainer<SelectValue> billClassificationContainer = (BeanItemContainer<SelectValue>) referenceData
				.get(SHAConstants.RRC_CATEGORY_CONTAINER);
		if(billClassificationContainer == null){
			billClassificationContainer =masterService.getMasterValueByReference(ReferenceTable.RRC_CATEGORY);
		}
