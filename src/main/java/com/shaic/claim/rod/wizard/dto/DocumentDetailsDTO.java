...
/**
 * @author ntv.vijayar
 * This File captures the user input
 * entered in document details section.
 */
...
//	@Size(min = 1 , message = "Please Enter Ifsc code")
	...
	private String txtHospitalCashClaimedAmnt;
...
*/
	...
	public void setHospitalCash(Boolean hospitalCash) {
		...
		this.hospitalCashFlag = hospitalCash != null && hospitalCash ? "Y" : "N" ;
	}
	...
	public void setHospitalCashFlag(String hospitalCashFlag) {
		this.hospitalCashFlag = hospitalCashFlag;
			if(this.hospitalCashFlag != null && this.hospitalCashFlag.equalsIgnoreCase("Y")) {
			this.hospitalCash = true;
			}
	}


	public String getTxtHospitalCashClaimedAmnt() {
		return txtHospitalCashClaimedAmnt;
	}


	public void setTxtHospitalCashClaimedAmnt(String txtHospitalCashClaimedAmnt) {
		this.txtHospitalCashClaimedAmnt = txtHospitalCashClaimedAmnt;
	}
	...
	public boolean isChkSubmittedDoc() {
	...
	public boolean isChkFieldVisitReport() {
	...
	public boolean isChkInvestigationReport() {
