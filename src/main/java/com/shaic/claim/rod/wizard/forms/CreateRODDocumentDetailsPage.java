...
//		}else
	...
	//	docCheckListLayout.setWidth("10%");
		...
		this.sectionDetailsListenerTableObj.init(preauthDto, SHAConstants.CREATE_ROD);
...
//		legalHeirDetails.setTableList(list);
	...
	//	documentDetailsPageLayout = new VerticalLayout(documentDetailsLayout,reconsiderationLayout,insuredLayout,documentCheckListValidation,paymentDetailsLayout);
		documentDetailsPageLayout = new VerticalLayout(documentDetailsLayout,this.sectionDetailsListenerTableObj,reconsiderationLayout,insuredLayout,docCheckListLayout,paymentDetailsLayout/*,legalHeirLayout*/);
...
//			FormLayout btnLayout = new FormLayout(cField1,cField2,cField3,cField4,btnHLayout);
				...
				)
		{
			...
			formLayout1 = new FormLayout(optPaymentMode,cmbPayeeName,txtReasonForChange,txtNameAsPerBank,btnHLayoutT,txtPanNo,txtEmailId);
			formLayout1.setMargin(false);
			...
			public void valueChange(ValueChangeEvent event) {
				...
				if(null != value)
				{
					...
					else if(getDifferenceBetweenDates(value) > 7)
					{
						...
						buttonsNamewithType.put(GalaxyButtonTypesEnum.OK.toString(), "OK");
						HashMap<String, Button> messageBoxButtons = GalaxyAlertBox
								.createAlertBox("Document Received Date can only be 7 days prior to current system date. But entered date is "+value.toString()+". Please renter a valid date", buttonsNamewithType);
	...
	*/
			...
			public void showCMDAlert() {	 
				...
				/* Label successLabel = new Label(
					...
					buttonsNamewithType.put(GalaxyButtonTypesEnum.OK.toString(), "OK");
					HashMap<String, Button> messageBoxButtons = GalaxyAlertBox
							.createInformationBox(SHAConstants.CMD_ALERT + "</b>", buttonsNamewithType);
					Button homeButton = messageBoxButtons.get(GalaxyButtonTypesEnum.OK
							.toString());
