...
public class SearchPCCZCRequestTable extends GBaseTable<SearchProcessPCCRequestTableDTO>{
	...
	public void tableSelectHandler(SearchProcessPCCRequestTableDTO t) {
		...
		if(t.getKey() !=null){					
			...
			if(pccRequest !=null && pccRequest.getLockFlag() !=null && pccRequest.getLockedBy() != null
				...
				fireViewEvent(MenuPresenter.SHOW_PROCESS_PCC_ZONAL_COORDINATOR_REQUEST_WIZARD, t,userName);
			}
		}
