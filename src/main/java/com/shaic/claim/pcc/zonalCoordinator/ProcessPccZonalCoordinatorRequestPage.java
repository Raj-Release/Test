...
public class ProcessPccZonalCoordinatorRequestPage extends ViewComponent {
	...
	public void addListener() {	
		...
		negotiation.addValueChangeListener(new Property.ValueChangeListener() {
			...
			public void valueChange(ValueChangeEvent event) {
				...
				fireViewEvent(ProcessPCCZonalCoordinatorRequestPresenter.ZONAL_COORDINATOR_GENERATE_NEGOTIATION_APPLICABLE, isChecked);				
			}
		});				
	}
	...
	public Boolean validatePage() {
		...
		if(negotiation != null && negotiation.getValue() != null){
			...
			if(txtRmksforNegotiationZonal != null && txtRmksforNegotiationZonal.getValue() == null){
				hasError=true;
