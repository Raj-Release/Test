...
public class SearchPccZonalCoordinatorViewImpl extends AbstractMVPView
		implements SearchPccZonalCoordinatorView , Searchable{
	
	@Inject
	private SearchPCCZCRequestForm searchForm;
	
	@Inject
	private SearchPCCZCRequestTable searchTable;
	...
	public void doSearch() {
		...
		fireViewEvent(SearchProcessZonalCoordinatorRequestPresenter.SEARCH_ZONAL_COORDINATOR_RQUEST, searchDto, userName,passWord);
	}
