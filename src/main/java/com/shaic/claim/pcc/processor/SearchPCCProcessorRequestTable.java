...
public class SearchPCCProcessorRequestTable extends GBaseTable<SearchProcessPCCRequestTableDTO>{
	...
	public void tableSelectHandler(SearchProcessPCCRequestTableDTO t) {
		...
		if(t.getKey() !=null){					
			...
			if(pccRequest !=null && pccRequest.getLockFlag() !=null && pccRequest.getLockedBy() != null
				...
				fireViewEvent(MenuPresenter.SHOW_PROCESS_PCC_PROCESSOR_REQUEST_WIZARD, t,userName);
			}
		}
