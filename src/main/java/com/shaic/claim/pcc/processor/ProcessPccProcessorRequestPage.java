...
public class ProcessPccProcessorRequestPage extends ViewComponent {
			...
			public void componentEvent(Event event) {
				if (cmbSelectRole.getValue() !=null) {
					...
					if(selectValue.getCommonValue() !=null){
						if(!isDisapprove){
							fireViewEvent(ProcessPccProcessorRequestPresenter.PCCCPROCESSOR_GENERATE_USER_DETAILS,selectValue.getCommonValue());
						}
					}
				}
			}			
	...
	public void generateapproveLayout() {
			...
			approveFLayout=new FormLayout(cmbSelectRole,txtRemarksforApprove);
	...
	public void generateDisapproveLayout() {
		...
		disApproveFLayout=new FormLayout(cmbSelectRole,txtRemarkForDisapprove);
