...
public class SearchProcessPCCDivisionHeadRequestForm extends SearchComponent<SearchProcessPCCRequestFormDTO>{
	...
	private ComboBox cmbPccQueryType;
	...
	public void init(String menuString) {
		...
		mainPanel = new Panel();
		mainPanel.setCaption("Division Head(PCC Process)");
