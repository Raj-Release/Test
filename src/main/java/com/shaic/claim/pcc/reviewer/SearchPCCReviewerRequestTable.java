...
public class SearchPCCReviewerRequestTable extends GBaseTable<SearchProcessPCCRequestTableDTO>{
	...
	public void tableSelectHandler(SearchProcessPCCRequestTableDTO t) {
		...
		fireViewEvent(MenuPresenter.SHOW_PROCESS_PCC_REVIEWER_REQUEST_WIZARD, t,userName);
