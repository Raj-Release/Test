...
public class SearchPccReviewerViewImpl extends AbstractMVPView implements SearchPccReviewerView , Searchable{
	
	@Inject
	private SearchPCCReviewerForm searchForm;
	
	@Inject
	private SearchPCCReviewerRequestTable searchTable;
	...
	public void doSearch() {
		...
		fireViewEvent(SearchProcessPCCReviewerRequestPresenter.SEARCH_PCC_REVIEWER_RQUEST, searchDto, userName,passWord);
	}
