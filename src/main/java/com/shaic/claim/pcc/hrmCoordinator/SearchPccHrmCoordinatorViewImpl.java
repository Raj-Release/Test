...
public class SearchPccHrmCoordinatorViewImpl extends AbstractMVPView implements
		SearchPccHrmCoordinatorView , Searchable{
	
	@Inject
	private SearchProcessPCCHRMRequestForm searchForm;
	
	@Inject
	private SearchPCCHRMRequestTable searchTable;
	...
	public void doSearch() {
		...
		fireViewEvent(SearchProcessHRMCoordinatorRequestPresenter.SEARCH_HRM_COORDINATOR_RQUEST, searchDto, userName,passWord);
	}
