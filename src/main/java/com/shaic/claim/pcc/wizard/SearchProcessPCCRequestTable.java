...
public class SearchProcessPCCRequestTable extends GBaseTable<SearchProcessPCCRequestTableDTO> {
	
	/**
	 * 
	 */
	private static final long serialVersionUID = 405405325543178091L;
	...
	public void tableSelectHandler(SearchProcessPCCRequestTableDTO t) {
		if(t.getKey() !=null){					
			...
			if(pccRequest !=null && pccRequest.getLockFlag() !=null && pccRequest.getLockedBy() != null
				...
				fireViewEvent(MenuPresenter.SHOW_PROCESS_PCC_CO_ORDINATOR_REQUEST_WIZARD, t,userName);
			}
		}
