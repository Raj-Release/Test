...
public class SearchPCCZMHRequestTable extends GBaseTable<SearchProcessPCCRequestTableDTO>{
	...
	public void tableSelectHandler(SearchProcessPCCRequestTableDTO t) {
		...
		if(t.getKey() !=null){					
			...
			if(pccRequest !=null && pccRequest.getLockFlag() !=null && pccRequest.getLockedBy() != null
				...
				fireViewEvent(MenuPresenter.SHOW_PROCESS_PCC_ZONAL_MEDICAL_HEAD_REQUEST_WIZARD, t,userName);
			}
		}
