...
public class SearchPccZonalMedicalHeadViewImpl extends AbstractMVPView implements
		SearchPccZonalMedicalHeadView , Searchable{
	
	@Inject
	private SearchPCCZMHRequestForm searchForm;
	
	@Inject
	private SearchPCCZMHRequestTable searchTable;
	...
	public void doSearch() {
		...
		fireViewEvent(SearchProcessPCCZonalmedicalHeadPresenter.SEARCH_PCC_ZONAL_MEDICAL_HEAD, searchDto, userName,passWord);
	}
