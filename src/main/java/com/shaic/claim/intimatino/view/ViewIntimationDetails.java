...
public class ViewIntimationDetails extends ViewComponent {
	...
	private static final long serialVersionUID = 1L;
	 ...
	 private TextField txtIntimationNo;
	    ...
	    public void init(ViewTmpIntimation intimation){
			...
			Intimation intimationObj = intimationService.getIntimationByKey(intimation.getKey());
