...
//	private ComboBox cmbPriorityNew;
	...
	private VerticalLayout buildSubmitSpecialFormLayout() {
		...
		txtPolicyNo = binder.buildAndBind("Policy No", "policyNo",
					TextField.class);
		comRefferedBy =binder.buildAndBind("Referred by (Doctor)","refferedBy",ComboBox.class);
		...
		cmbSpecialitType = binder.buildAndBind("Specialist Type","specialistType",ComboBox.class);
