...
//				.getProduct().getCode());
		...
		TabSheet productDetails = bindProductDetailsFromPolicyTab();
	...
	public void showValues(PremPolicyDetails policyNumber) {		
		...
		TabSheet productDetails = bindProductDetailsTabForPremia();
		mainLayout.addComponent(productDetails);
	...
	public void showValues(PremPolicy policyNumber) {		
		...
		TabSheet productDetails = bindProductDetailsTabForSearchPolicy();
		mainLayout.addComponent(productDetails);
...
//	}
	...
	private TabSheet bindProductDetailsTab() {
...
//		a_productCondition.showValues(policy);
		...
		a_viewProcedureDetails.showValues(product);
	...
	private TabSheet bindProductDetailsFromPolicyTab() {
		TabSheet productDetails = new TabSheet();
		//Vaadin8-setImmediate() productDetails.setImmediate(true);
		productDetails.setWidth("100.0%");
		productDetails.setHeight("100.0%");
	...
	private TabSheet bindProductDetailsTabForSearchPolicy() {
		TabSheet productDetails = new TabSheet();
		//Vaadin8-setImmediate() productDetails.setImmediate(true);
		productDetails.setWidth("100.0%");
		productDetails.setHeight("100.0%");
	...
	private TabSheet bindProductDetailsTabForPremia() {
		TabSheet productDetails = new TabSheet();
		//Vaadin8-setImmediate() productDetails.setImmediate(true);
		productDetails.setWidth("100.0%");
		productDetails.setHeight("100.0%");
	...
	protected void getViewPolicyClause(String policyNumber) {
		...
		if (policyNumber != null){			
		 policyDetails = policyService.getPolicy(policyNumber);
		 if (policyDetails != null && policyDetails.getProduct().getDocumentToken() != null) {
