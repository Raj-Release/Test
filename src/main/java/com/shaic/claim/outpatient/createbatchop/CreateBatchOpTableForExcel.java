...
public class CreateBatchOpTableForExcel extends GBaseTable<CreateBatchOpTableDTO>{
	...
	private static final Object[] NATURAL_COL_ORDER = new Object[]{"intimationNo","claimNo","policyNo","billAmt","payableAmt","payeeNameStr","chequeNo","chequeDate","ifscCode","bankName","totalBillAmt","deductionAmt","totalPayableAmt","remarks"};
