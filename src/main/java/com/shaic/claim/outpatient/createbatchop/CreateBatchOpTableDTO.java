...
public class CreateBatchOpTableDTO extends AbstractTableDTO  implements Serializable{
	...
	private Long opHealthCheckUpKey;
...
/*	public Long getIfscCode() {
	...
	public Long getOpHealthCheckUpKey() {
		return opHealthCheckUpKey;
	}

	public void setOpHealthCheckUpKey(Long opHealthCheckUpKey) {
		this.opHealthCheckUpKey = opHealthCheckUpKey;
	}
