...
//							.getPolicyNumber());
			...
			txtNoOfDays = (TextField) binder.buildAndBind("No of Days",
...
//			txtNegotiationWith.setValue(bean.getPreauthMedicalDecisionDetails().getNegotiationWith());
			...
			FormLayout firstForm = new FormLayout(txtPreauthReceivedDate,
					...
					txtRoomCategory, illnessLayout, txtSpecify,
					txtTreatementType, txtPatientStatus, txtDateOfDeath,
					txtReasonForDeath, txtTerminateCover,
					initiateFieldVisitRequestRadio, txtPreAuthType,txtTimeBasedIcdCodeExclusion/*, txtInvestigatorName,
					txtInvestigatorRemarks*/);
			VerticalLayout vLeftLayout = new VerticalLayout();
			vLeftLayout.addComponents(firstForm,viewInvestigationRemarksTable);;
