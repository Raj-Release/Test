...
public class ViewHospitalizationListenerTable  extends ViewComponent { 
	...
	void initTable() {
		...
		//table.setVisibleColumns(new Object[] { "itemNoForView", "itemName","noOfDays", "perDayAmt", "itemValue" , "noOfDaysAllowed" , "perDayAmtProductBased" , "amountAllowableAmount" , "nonPayableProductBased" , "nonPayable" , "proportionateDeduction" ,"reasonableDeduction" , "totalDisallowances" , "netPayableAmount" , "deductibleOrNonPayableReason" , "medicalRemarks"});
		...
		if(null != this.presenterString  && (SHAConstants.BILLING.equalsIgnoreCase(this.presenterString) || (SHAConstants.FINANCIAL).equalsIgnoreCase(this.presenterString)))
		{
			...
			/*else
			{
				table.setVisibleColumns(new Object[] { "itemNoForView", "itemName","noOfDays", "perDayAmt", "itemValue" , "noOfDaysAllowed" , "perDayAmtProductBased" , "amountAllowableAmount" , "nonPayableProductBased" , "nonPayable" , "proportionateDeduction" ,"reasonableDeduction" , "totalDisallowances" , "netPayableAmount" , "deductibleOrNonPayableReason"});
			}*/
		}
