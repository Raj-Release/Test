...
public class ViewDiagnosisTable extends GBaseTable<DiagnosisDetailsTableDTO> {
	...
	public void initTable() {
		...
		table.setContainerDataSource(diagnosisDetailsContainer);
		 ...
		 Object[] VISIBLE_COLUMNS = new Object[] {"serialNumber","primaryDiagnosis",
			"diagnosis",/*"icdChapterValue","icdBlockValue",*/"icdCodeValue", "pedImpactOnDiagnosis.value", "sublimitApplicableValue", "sublimitNameValue","sublimitAmt","considerForPaymentValue", "reasonForNotPaying.value", "sumInsuredRestrictionValue" };
	...
	public void setVisibleColumn(){   
	 Object[] NATURAL_COLUMNS = new Object[] {"serialNumber","primaryDiagnosis",
			"diagnosis","pedImpactOnDiagnosis.value", "sublimitApplicableValue", "sublimitNameValue","sublimitAmt","exclusionDiagnosis","exclusionDetailsValue","coPayValue","considerForPaymentValue", 
	...
	public void setMoreColumn(){
		Object[] MORE_COLUMNS = new Object[] {"serialNumber","primaryDiagnosis",
			"diagnosis",/*"icdChapterValue","icdBlockValue",*/"icdCodeValue","sublimitApplicableValue", "sublimitNameValue","sublimitAmt","exclusionDiagnosis","exclusionDetailsValue",
			"coPayValue","considerForPaymentValue", "sumInsuredRestrictionValue","diagnosisRemarks" };
