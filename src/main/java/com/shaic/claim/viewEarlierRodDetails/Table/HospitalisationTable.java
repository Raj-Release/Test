...
public class HospitalisationTable extends ViewComponent {
...
/**
	...
	void initTable() {
		...
		table.setVisibleColumns(new Object[] {"serialNum", "details","noOfDays", "perDayAmt", "claimedAmount", "billingNonPayableAmt", "netAmount", "entitlementNoOfDays",
				"entitlementPerDayAmt","amount","deductionNonPayableAmount","payableAmount","reason" });
        
		table.setColumnHeader("serialNum", "S.No");
		...
		table.setColumnWidth("serialNum", 50);
		table.setColumnWidth("details", 400);
		table.setColumnWidth("noOfDays", 100);
		table.setColumnWidth("perDayAmt", 100);
		table.setColumnWidth("claimedAmount", 100);
		table.setColumnWidth("billingNonPayableAmt", 100);
		...
		table.setColumnWidth("deductionNonPayableAmount", 100);
		table.setColumnWidth("payableAmount", 100);
		table.setColumnWidth("reason", 200);
		table.setFooterVisible(true);
...
//				
	 ...
	 public String getPayableAmount(){
		 return this.table.getColumnFooter("payableAmount");
	 }
	 
	 public String getClaimedAmount(){
		 return this.table.getColumnFooter("claimedAmount");
	 }
