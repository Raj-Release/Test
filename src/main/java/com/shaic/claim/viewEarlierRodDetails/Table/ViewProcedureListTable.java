...
public class ViewProcedureListTable extends GBaseTable<ProcedureDTO> {
	...
	public void initTable() {
		...
		table.setContainerDataSource(new BeanItemContainer<ProcedureDTO>(
				ProcedureDTO.class));
		 Object[] NATURAL_COL_ORDER = new Object[] {"serialNumber","procedureNameValue","procedureCodeValue","pakageRate","dayCareProcedure","considerForDayCareValue"
			,"sublimitApplicableFlag","sublimitNameValue","subLimitAmount","considerForPaymentValue","remarks"};
