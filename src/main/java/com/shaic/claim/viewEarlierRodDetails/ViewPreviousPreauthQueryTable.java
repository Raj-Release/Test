...
import com.shaic.claim.preauth.wizard.pages.PreAuthPreviousQueryDetailsTableView;
...
public class ViewPreviousPreauthQueryTable extends
GBaseTable<PreAuthPreviousQueryDetailsTableDTO> {
	...
	private static final Object[] NATURAL_COL_ORDER = new Object[] { "queryNo",
		"hospitalName", "hospitalCity", "diagnosis", "opnQryTyp", "queryRemarks",
