...
public class BillingProcessButtonsUI extends ViewComponent {
	...
	public void initView(PreauthDTO bean, GWizard wizard) 
	{
		...
		HorizontalLayout buttonFirstLayout = new HorizontalLayout(referCoordinatorBtn, referToMedicalApproverBtn, sendToFinancialApprovalBtn,cancelROD,btnBillAssessmentSheet,referToBillEntry);
