...
public class HopitalizationCalulationDetailsDTO implements Serializable {
	...
	public Boolean getOnBackFlag() {
		return onBackFlag;
	}
	public void setOnBackFlag(Boolean onBackFlag) {
		this.onBackFlag = onBackFlag;
	}
