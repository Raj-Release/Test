...
//		GridLayout grid = new GridLayout(5,3);
		...
		{
			formLayout1 = new FormLayout(optPaymentMode, txtPayModeChangeReason, cmbPayeeName, txtReasonForChange, txtPanNo, txtEmailId, btnPayableAtHLayout, txtAreaBillingInternalRemarks);
		}
		else
		{
