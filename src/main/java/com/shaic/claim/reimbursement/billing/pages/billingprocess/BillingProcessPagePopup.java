...
public class BillingProcessPagePopup extends ViewComponent {
		...
		if (filledDTO.isEmpty()) {
			...
			if (null != medicalDecisionDTOList
				...
				for (int i = 0; i < medicalDecisionDTOList.size(); i++) {
					...
					fireViewEvent(
							BillingProcessPagePresenter.SUM_INSURED_CALCULATION,
				...
				if(this.bean.getResidualAmountDTO() != null && this.bean.getResidualAmountDTO().getKey() != null) {
					...
					SelectValue value1 = new SelectValue();
					value1.setId(residualAmountDTO.getCopayPercentage() != null ? residualAmountDTO.getCopayPercentage().longValue() : 0l);
					value1.setValue(residualAmountDTO.getCopayPercentage() != null ? String.valueOf(residualAmountDTO.getCopayPercentage().intValue())  : "0");
					
					diagnosisDTO.setCoPayPercentage(value1);
						...
						if(approvedAmount > balanceSI){
							...
							if((bean.getNewIntimationDTO().getPolicy().getProduct().getKey() != null 
								...
								{								
									...
									{
											fireViewEvent(BillingProcessPagePresenter.RTA_RECHARGE_SI_FOR_PRODUCT, this.bean);
										...
										&& this.bean.getNewIntimationDTO().getPolicy().getProduct().getRechargeSiFlag().equalsIgnoreCase("Y"))
								{
									fireViewEvent(BillingProcessPagePresenter.RECHARGE_SI_FOR_PRODUCT, this.bean);
