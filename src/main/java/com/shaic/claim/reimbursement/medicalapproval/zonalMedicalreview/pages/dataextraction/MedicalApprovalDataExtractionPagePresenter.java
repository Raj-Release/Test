...
@ViewInterface(MedicalApprovalDataExtractionPageInterface.class)
public class MedicalApprovalDataExtractionPagePresenter  extends AbstractMVPPresenter<MedicalApprovalDataExtractionPageInterface>{
	private static final long serialVersionUID = 4997791214190939761L;
	...
	public static final String MEDICAL_APPROVAL_SETUP_REFERNCE = "medical_approval_setup_reference";
	
	public static final String SUBLIMIT_CHANGED_BY_SECTION = "Set sublimit values by selecting section for zonal review";
	
	public static final String CHECK_CRITICAL_ILLNESS = "medical_approval_check_critical_illness";
	
	public static final String MEDICAL_APPROVAL_TREATMENT_TYPE_CHANGED = "medical_approval_treatment_type_changed";
	
	public static final String MEDICAL_APPROVAL_PATIENT_STATUS_CHANGED = "medical_approval_patient_status_changed";
	
	public static final String MEDICAL_APPROVAL_HOSPITALISATION_DUE_TO = "medical_approval_hospitalisation_due_to";
	
	public static final String MEDICAL_APPROVAL_GENERATE_OTHER_CLAIMS = "medical_approval_generate_other_claims";
	
	public static final String MEDICAL_APPROVAL_COORDINATIOR ="Medical approval coordinator";
	
	public static final String GET_ICD_BLOCK = "medical_approval_zonal_review_get_icd_block";
	
	public static final String GET_ICD_CODE = "medical_approval_zonal_review_get_icd_code";
	
	public static final String GET_ZONAL_PROCEDURE_VALUES ="medical_zonal_procedure_values";
	
	public static final String GET_SEC_COVER = "zonal_get_sec_cover";
	
	public static final String GET_SUB_COVER = "zonal_get_sub_cover";
	
	public static final String GET_PACKAGE_RATE = "medical_approval_zonal_review_get_package_rate";
	public static final String MEDICAL_APPROVAL_REPORTED_TO_POLICE = "medical_approval_reported_to_police";
	
	public static final String COMPARE_WITH_PREVIOUS_ROD = "medical_approval_compare_with_previous_rod";

	public static final String GENERATE_DOMICILLARY_FIELDS = "medical_approval_generate_domicillary_hospitalization";
	
	public static final String SET_DB_DETAILS_TO_REFERENCE_DATA = "medical_approval_set_db_details_to_reference_data";
	public static final String REFERENCE_DATA_CLEAR = "reference clear zaonal medical data extraction";
	
	public static final String GET_RTA_BALANCE_SI = "Get_RTA_Balance_SI";
	
	public static final String GET_ASSISTED_REPRODUCTION_TREATMENT_COVER_KEY_ZMR = "GET_ASSISTED_REPRODUCTION_TREATMENT_COVER_KEY_ZMR";

	public static final String SAVE_OTHER_BENEFITS_TABLE_VALUES_ZMR = "save_other_benefits_table_values_zmr";
...
//		referenceData.put("icdCode", masterService.getSelectValuesForICDCode());
		...
		referenceData.put("surgicalSpeciality", preauthService.getSpecialityType("S"));referenceData.put("sublimitApplicable", masterService.getSelectValueContainer(ReferenceTable.COMMON_VALUES));
...
//		referenceData.put("sublimitDBDetails", dbCalculationService.getClaimedAmountDetails(dto.getPolicyDto().getProduct().getKey(), sumInsured, insuredAge));
		...
		Reimbursement reimbursementByKey = acknowledgementDocumentsReceivedService.getReimbursementByKey(dto.getKey());
		...
		if(reimbursementByKey != null && reimbursementByKey.getDocAcknowLedgement() != null){
			...
			if(isSettled){
				if(reimbursementByKey.getReconsiderationRequest() != null && reimbursementByKey.getReconsiderationRequest().equalsIgnoreCase("Y") 
					...
					List<ReimbursementCalCulationDetails> reimbursementCalculationDetails = acknowledgementDocumentsReceivedService.getReimbursementCalculationDetails(dto.getKey());
...
//		List<Double> copayValue = dbCalculationService.getProductCoPay(intimationDTO.getPolicy().getProduct().getKey() ,intimationDTO.getInsuredPatient().getKey(), intimationDTO.getInsuredPatient().getInsuredId());
//	
//		dto.setBalanceSI(SHAUtils.getHospOrPartialAppAmt(dto, reimbursementService, balanceSI));
//		
//
...
//		if(reimbursementByKey != null && reimbursementByKey.getDocAcknowLedgement() != null){
//			DocAcknowledgement docAcknowLedgement = reimbursementByKey.getDocAcknowLedgement();
//			if(docAcknowLedgement.getReconsiderationRequest() != null && docAcknowLedgement.getReconsiderationRequest().equalsIgnoreCase("Y") 
//					&& docAcknowLedgement.getPaymentCancellationFlag() != null && docAcknowLedgement.getPaymentCancellationFlag().equalsIgnoreCase("N")){
//				Double alreadyPaidAmt = 0d;
//				List<ReimbursementCalCulationDetails> reimbursementCalculationDetails = acknowledgementDocumentsReceivedService.getReimbursementCalculationDetails(dto.getKey());
//				for (ReimbursementCalCulationDetails reimbursementCalCulationDetails2 : reimbursementCalculationDetails) {
...
//	
	...
	//	Integer sumInsured = dbCalculationService.getInsuredSumInsured(preauthDTO.getPolicyDto().getKey(), preauthDTO.getNewIntimationDTO().getInsuredPatient().getInsuredId().toString());
		...
		referenceData.put("detailsMap",detailsMap);
...
//		view.setWizardPageReferenceData(referenceData);
	...
	public void coordinatorEvent(@Observes @CDIEvent(MEDICAL_APPROVAL_COORDINATIOR) final ParameterDTO parameters){
	...
	public void getIcdCode(@Observes @CDIEvent(GET_ICD_CODE) final ParameterDTO parameters)
	{
		...
		/*BeanItemContainer<SelectValue> selectValueContainer = new BeanItemContainer<SelectValue>(
				SelectValue.class);
		if(blockKey != null && blockKey == 0l){
			selectValueContainer = masterService.getIcdCodes();
		} else {
	...
	public void getProcedureValues(
			@Observes @CDIEvent(GET_ZONAL_PROCEDURE_VALUES) final ParameterDTO parameters) {
		...
		view.setZonalProcedureValues(procedures);
	}
...
//			}
	...
	public void generateFieldsBasedOnDomicillaryHospitalization(@Observes @CDIEvent(GENERATE_DOMICILLARY_FIELDS) final ParameterDTO parameters)
	{
		Boolean selectedValue = (Boolean) parameters.getPrimaryParameter();
		view.genertateFieldsBasedOnDomicillaryHosp(selectedValue);
	}
	...
	public void getAssistedReprodTreatment(@Observes @CDIEvent(GET_ASSISTED_REPRODUCTION_TREATMENT_COVER_KEY_ZMR) final ParameterDTO parameters) {
		...
		public void saveOtherBenefitsValue(@Observes @CDIEvent(SAVE_OTHER_BENEFITS_TABLE_VALUES_ZMR) final ParameterDTO parameters)
		{
			PreauthDTO preauthDTO = (PreauthDTO)parameters.getPrimaryParameter();
			DocAcknowledgement docAck = preauthDTO.getPreauthDataExtractionDetails().getDocAckknowledgement();			
			acknowledgementDocumentsReceivedService.updateOtherBenefitsValues(preauthDTO,docAck);		
		}
