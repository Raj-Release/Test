...
//					}
	...
	/*	HorizontalLayout horizontalLayout1 = new HorizontalLayout(
		...
		if((bean.getNewIntimationDTO().getPolicy().getProduct().getKey() != null && ReferenceTable.getFHORevisedKeys().containsKey(bean.getNewIntimationDTO().getPolicy().getProduct().getKey()))
			...
			buttonsLayout = new HorizontalLayout(btnRRC,btnLumen,btnViewPolicySchedule,btnPolicyScheduleWithoutRisk,btnHospitalScroing,seriousDeficiency,btnViewDoctorRemarks,elearnBtn,viewEarlierRODDetails,btnViewRTABalanceSI,btnZUAAlert,btnViewPackage,viewPreauthButton);
			...
			buttonsLayout = new HorizontalLayout(btnRRC,btnLumen,btnViewPolicySchedule,btnPolicyScheduleWithoutRisk,btnHospitalScroing,seriousDeficiency,btnViewDoctorRemarks,elearnBtn,viewEarlierRODDetails,updatePreviousButton,btnZUAAlert,btnViewPackage,viewPreauthButton);
			secondLayout1 = new HorizontalLayout(buttonsLayout);

		}
		else if(ReferenceTable.getGMCProductList().containsKey(bean.getNewIntimationDTO().getPolicy().getProduct().getKey()))
		{
			HorizontalLayout hTempLayout1 = new HorizontalLayout(btnRRC,btnLumen,btnViewPolicySchedule,btnPolicyScheduleWithoutRisk,btnHospitalScroing,seriousDeficiency,btnViewDoctorRemarks,elearnBtn,viewEarlierRODDetails,btnViewRTABalanceSI,btnZUAAlert,btnViewPackage);
