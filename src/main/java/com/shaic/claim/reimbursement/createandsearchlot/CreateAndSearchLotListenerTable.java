	...
	void initTable() {
				...
				(SHAConstants.QUICK_SEARCH).equalsIgnoreCase(presenterString))
		{
			...
			table.setVisibleColumns(new Object[] { "serialNo","chkSelect", "viewLinkedPolicy" ,"viewdetails","legaldetails","intimationNo","claimNo","policyNo","rodNo","paymentStatus","product","cpuCode","paymentCpucodeTextValue","paymentCpuCodeSearch","emailID","paymentType",
					"payModeChangeReason","ifscCode","Search","beneficiaryAcntNo",/*"accountVerificationDetails",*/"bankName","branchName","typeOfClaim","approvedAmt","payeeNameStr","payeeNameSearch","legalFirstName","reasonForChange","gmcProposerName","gmcEmployeeName","payableAt","payableAtSearch","panNo","providerCode","dbSideRemark" });
