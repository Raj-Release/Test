...
//				this.claimDto,"Submit Specialist Advise");
		...
		HorizontalLayout hlayout=new HorizontalLayout(crmIconLayout, hopitalFlag);
...
//		mainsplitPanel.setSizeFull();
	...
	public HorizontalLayout commonButtonsLayout()
	{
		...
		HorizontalLayout alignmentHLayout = new HorizontalLayout(btnRRC,btnTrail,btnClaimStatus,btnCompleted);
