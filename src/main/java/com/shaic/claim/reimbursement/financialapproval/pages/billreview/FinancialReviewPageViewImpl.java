...
public class FinancialReviewPageViewImpl extends AbstractMVPView implements FinancialReviewPageWizard {

	private static final long serialVersionUID = -1756934701433733987L;
	
	@Inject
	private FinancialReviewPageUI billingReviewPage;
	...
	public FinancialReviewPageUI getBillingReviewPage() {
		return billingReviewPage;
	}

	public void setBillingReviewPage(FinancialReviewPageUI billingReviewPage) {
		this.billingReviewPage = billingReviewPage;
	}
	...
	public Component getContent() {
		...
		fireViewEvent(FinancialReviewPagePresenter.BILLING_REVIEW_SET_UP_REFERENCE, bean);
		return comp;
	}
	...
	public boolean onAdvance() {
		if(billingReviewPage.validatePage()){
			...
			fireViewEvent(FinancialReviewPagePresenter.BILLING_DETAILS_UPDATE, bean);
			fireViewEvent(FinancialReviewPagePresenter.GET_MAPPING_DATA, bean.getKey(), true);
...
//				}
			...
			fireViewEvent(FinancialReviewPagePresenter.GET_MAPPING_DATA, bean.getKey(), false);
	...
	public boolean onBack() {
		fireViewEvent(FinancialReviewPagePresenter.GET_MAPPING_DATA, bean);
		bean.setIsBack(true);
		return true;
	}
	...
	@Override
	public void generateRejectLayout(BeanItemContainer<SelectValue> rejectionContainer) {
		billingReviewPage.generateButton(8, rejectionContainer);
	...
	public void setClrearReferenceData(){
	...
	public void confirmRejectionLayout(Object rejectionCategoryDropdownValues,Boolean isDefinedLimitReject){
		billingReviewPage.confirmRejectionLayout(rejectionCategoryDropdownValues, isDefinedLimitReject);
	}

	@Override
	public void alertMsgForCancelRod(String screenName) {
		billingReviewPage.alertMsgForCancelRod(screenName);
		
	}

	@Override
	public void generateQueryLayout() {
		billingReviewPage.generateButton(7, null);
		
	}
	
	@Override
	public void alertMsgForInvsPending(String decisionStatus) {
		billingReviewPage.alertMsgForInvsPending(decisionStatus);
	}
	
	@Override
	public void setSubCategContainer(BeanItemContainer<SelectValue> rejSubcategContainer) {
		billingReviewPage.setSubCategContainer(rejSubcategContainer);
	}
