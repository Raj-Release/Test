...
//			formLayout1 = new FormLayout(optPaymentMode, txtPayModeChangeReason, txtEmailId, txtPanNo, txtAreaFAInternalRemarks);
			...
			formLayout1 = new FormLayout(optPaymentMode,cmbPayeeName,txtReasonForChange,txtNameAsPerBank,btnPayableAtHLayout,txtPanNo,txtEmailId,txtAreaFAInternalRemarks);
			formLayout1.setMargin(false);
