...
//		}
		...
		firstFLayout = new FormLayout(admissionDate, cmbRoomCategory, illnessFLayout, cmbSpecifyIllness, preauthApprovedAmt, cmbSection/*,optDocumentVerified*/);
		}
		else
		{
			firstFLayout = new FormLayout(admissionDate, cmbRoomCategory, illnessFLayout, cmbSpecifyIllness, preauthApprovedAmt, cmbSection,domicillaryHospitalisation/*,optDocumentVerified*/);
		}
...
//			dialog.setContent(firstForm);
		...
		public void displayAlert(){
			...
			if(null != memberType && !memberType.isEmpty() && memberType.equalsIgnoreCase(SHAConstants.CMD)){
				alertList.add(SHAConstants.CMD_ALERT +LINE_BRK);
			}
