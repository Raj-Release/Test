...
@ViewInterface(FinancialReviewPageWizard.class)
public class FinancialReviewPagePresenter extends AbstractMVPPresenter<FinancialReviewPageWizard>{
	...
	@EJB
	private InvestigationService invesService;
	
	
	public static final String BILLING_HOSPITAL_BENEFITS = "financial_hospital_cash_benefits";
	public static final String BILLING_PATIENT_CARE_BENEFITS = "financial_patiet_care_benefits";
	public static final String BILLING_REVIEW_SET_UP_REFERENCE = "financial_review_set_up_reference";
	public static final String BILLING_DETAILS_UPDATE = "financial_billing update details";
	public static final String VIEW_BILLING_WORKSHEET = "billing_worksheet";


	public static final String BILLING_TREATMENT_TYPE_CHANGED = "financial_treatment_type_changed";


	public static final String BILLING_COORDINATOR = "financial_coordinator";
	
	public static final String GET_SEC_COVER = "financial_get_sec_cover";
	
	public static final String GET_SUB_COVER = "financial_get_sub_cover";


	public static final String BILLING_PATIENT_STATUS_CHANGED = "financial_patient_status_changed";
	public static final String CLAIM_HOSPITAL_BENEFITS = "claim_financial_hospital_benefits";
	public static final String CLAIM_PATIENT_CARE_BENEFITS = "claim_financial_patient_care_benefits";


	public static final String BILL_ENTRY_TABLE_CATEGORY_DROPDOWN_VALUE = "financial_bill_entry_category_dropdown_values";
	
	public static final String FINANCIAL_BILL_REVIEW_IRDA_LEVEL2_VALUES = "financial_bill_review_irda_level2_values";
	
	public static final String FINANCIAL_BILL_REVIEW_IRDA_LEVEL3_VALUES = "financial_bill_review_irda_level3_values";



	public static final String BILL_ENTRY_COMPLETION_STATUS = "financial_bill_entry_completion_status";
	
	public static final String SAVE_PATIENT_CARE_TABLE_VALUES = "Update Patient Care Table Values for Claim financial";
	
	public static final String SAVE_HOSPITAL_CASH_TABLE_VALUES = "Update Hospital Cash Table Values for Claim financial";
	
	public static final String SAVE_OTHER_BENEFITS_TABLE_VALUES = "Save other benefits value for claim financial";


	public static final String COMPARE_WITH_PREVIOUS_ROD = "process_financial_compare_with_previous_rod";
	
	public static final String FA_SETUP_IFSC_DETAILS = "FA_Setup_ifsc_details";
	
	public static final String GET_MAPPING_DATA = "financial_get_mapping_data";
	
	public static final String FINANCIAL_CANCEL_ROD="financial_cancel_rod_for_first_page";
	
	public static final String FINANCIAL_REFERCOORDINATOR_EVENT = "financial_refer_to_coordinator_event_for_first_page";
	
	public static final String FIANANCIAL_REFER_TO_BILLING_EVENT = "financial_refer_to_billing_event_for_first_page";
	
	public static final String FINANCIAL_REFER_TO_MEDICAL_APPROVER_EVENT = "financial_refer_to_medical_approver_event_for_first_page";
	
	public static final String FIANANCIAL_REJECT_EVENT = "financial_reject_event_for_first_page";
	
	public static final String FA_SAVE_BILL_ENTRY_VALUES = "fa_save_bill_entry_values";
	
	public static final String FA_LOAD_BILL_DETAILS_VALUES = "fa_load_bill_details_values";
	public static final String FINANCIAL_REFER_TO_BILL_ENTRY = "financial_refer_to_bill_entry";
	
	public static final String FA_UPDATE_PRODUCT_BASED_AMT = "fa_update_product_based_amt";

	protected static final String CHECK_CRITICAL_ILLNESS = "financial critical illness check";
	
	public static final String GET_RTA_BALANCE_SI = "Get_RTA_Balance_SI";
	
	public static final String GET_BENEFIT_DETAILS = "Get benefit details for financial";
	public static final String FIANANCIAL_REVIEW_QUERY_EVENT = "financial_review_query_event";
	public static final String FA_REJECT_SUB_CATEG_LAYOUT = "Rejection Subcategory Layout for FA";
	
	public static final String SETUP_NOMINEE_IFSC_DETAILS_FA = "set up Nominee IFSC Details For FA";

	public static final String GENERATE_DOMICILLARY_FIELDS = "Financial_generate_domicillary_fields";
	public static final String SET_DB_DETAILS_TO_REFERENCE_DATA = "Financial_set_db_details_to_reference_data";
	...
	public void saveBillValues(
			@Observes @CDIEvent(FA_SAVE_BILL_ENTRY_VALUES) final ParameterDTO parameters) {
	...
	public void loadBillDetailsValues(
			@Observes @CDIEvent(FA_LOAD_BILL_DETAILS_VALUES) final ParameterDTO parameters) {
		UploadDocumentDTO uploadDTO = (UploadDocumentDTO) parameters.getPrimaryParameter();
	...
	public void viewBillingWorkSheet(@Observes @CDIEvent(VIEW_BILLING_WORKSHEET) final ParameterDTO parameters){
		
		PreauthDTO preauthDTO =(PreauthDTO) parameters.getPrimaryParameter();
		view.viewBillingWorkSheet(preauthDTO);
...
//		preauthDTO = SHAUtils.roomRentNursingMapping(preauthDTO, 8l, 9l, false);
//		preauthDTO = SHAUtils.roomRentNursingMapping(preauthDTO, 10l, 11l, true);
//		if(preauthDTO.getIsICUoneMapping() || preauthDTO.getIsOneMapping()) {
//			reimbursementService.saveRoomRentNursingMapping(preauthDTO, preauthDTO.getRoomRentMappingDTOList());
...
//		BeanItemContainer<SelectValue> selectValueContainer = masterService.getMasBillCategoryValues(billClassificationKey,claimType);
		...
		if((ReferenceTable.STAR_WEDDING_GIFT_INSURANCE.equals(productKey) || (ReferenceTable.getComprehensiveProducts().containsKey(productKey))) && (!ReferenceTable.getMaternityMap().containsKey(subCoverValue))||
				ReferenceTable.POS_FAMILY_HEALTH_OPTIMA.equals(productKey)) 
	...
	public void setUpIRDALevel2Values(
			@Observes @CDIEvent(FINANCIAL_BILL_REVIEW_IRDA_LEVEL2_VALUES) final ParameterDTO parameters) {
	...
	public void setUpIRDALevel3Values(
			@Observes @CDIEvent(FINANCIAL_BILL_REVIEW_IRDA_LEVEL3_VALUES) final ParameterDTO parameters) {
	...
	public void generateRejSubCategoryLayoutForFA(
			@Observes @CDIEvent(FA_REJECT_SUB_CATEG_LAYOUT) final ParameterDTO parameters) {
...
//				}
		...
		{
			PreauthDTO preauthDTO = (PreauthDTO) parameters.getPrimaryParameter();
			reimbService.isFvrOrInvesOrQueryInitiated(preauthDTO);
		...
		{
			PreauthDTO preauthDTO = (PreauthDTO) parameters.getPrimaryParameter();
			Boolean isInvsAvailable = invesService.getInvestigationAvailableForClaim(preauthDTO.getClaimDTO().getKey());
			...
			else
			{
				if(preauthDTO.getNewIntimationDTO().getPolicy().getProduct().getCode() != null && 
					...
					view.generateRejectLayout(masterService.getReimbRejCategoryByValue());  
				}
			}//masterService.getSelectValueContainer(ReferenceTable.REJECTION_CATEGORY));
		}
		

		 public void generateReferToBillEntryLayout(@Observes @CDIEvent(FINANCIAL_REFER_TO_BILL_ENTRY) final ParameterDTO parameters){
				view.generateReferToBillEntryLayout();
		 }

		
		 public void setProductBasedAmt(
					@Observes @CDIEvent(FA_UPDATE_PRODUCT_BASED_AMT) final ParameterDTO parameters) {
		 ...
		 public void getSecCover(
			...
			public void generateQueryLayout(@Observes @CDIEvent(FIANANCIAL_REVIEW_QUERY_EVENT) final ParameterDTO parameters)
			{
			...
			public void getNomineeIFSCDetails(@Observes @CDIEvent(SETUP_NOMINEE_IFSC_DETAILS_FA) final ParameterDTO parameters)
			{
				ViewSearchCriteriaTableDTO viewSearchCriteriaDTO = (ViewSearchCriteriaTableDTO) parameters.getPrimaryParameter();
