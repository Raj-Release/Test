 ...
 *
 */
public class ReviewRRCRequestViewImpl extends AbstractMVPView 
implements ReviewRRCRequestDataExtractionView {
	
	@Inject
	private ReviewRRCRequestDataExtractionPage documentDetailsPage;
	...
	public void init(RRCDTO bean, GWizard wizard) {
		this.bean = bean;
		documentDetailsPage.initPresenter(SHAConstants.REVIEW_RRC_REQUEST);
