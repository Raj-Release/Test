 ...
 *
 */
public class ReviewRRCRequestWizardViewImpl extends AbstractMVPView implements ReviewRRCRequestDataExtractionWizard {
	
	@Inject
	private Instance<ReviewRRCRequestDataExtractionView> reviewRRCRequestDataExtractionObj;
	private ReviewRRCRequestDataExtractionView reviewRRCRequestDataExtraction;
	...
	private SearchReviewRRCRequestTableDTO reviewProcessRRCDTO;
...
/*		item.addNestedProperty("documentDetails.documentCheckList");
	...
	public void initView(RRCDTO preauthDTO)
	{
		...
		initBinder();	
		reviewRRCRequestDataExtraction = reviewRRCRequestDataExtractionObj.get();
		reviewRRCRequestDataExtraction.init(bean,wizard);
		wizard.addStep(this.reviewRRCRequestDataExtraction,"Review RRC Request");
...
//					}
		...
		reviewProcessRRCDTO = new SearchReviewRRCRequestTableDTO();
		...
		vMainLayout.addComponent(verticalLayout);
  ...
  public void getErrorMessage(String eMsg){
	...
	public void wizardCompleted(WizardCompletedEvent event) {
		if(reviewRRCRequestDataExtraction.onAdvance())
		{
			fireViewEvent(ReviewRRCRequestPresenter.SUBMIT_RRC_REQUEST_FOR_REVIEW, bean);
		}
	}
	...
	public void wizardCancelled(WizardCancelledEvent event) {
		// TODO Auto-generated method stub
		releaseHumanTask();
		fireViewEvent(MenuItemBean.REVIEW_RRC_REQUEST, null);
	}
	...
	public void buildSuccessLayout(String rrcRequestNo) {
		...
		{
			 successMessage = "RRC RequestNo" + " " + rrcRequestNo + " Successfully submitted for processing !!!";
		}
		else {
	...
	public boolean onSave() {
	 ...
	 public void setsubCategoryValues(BeanItemContainer<SelectValue> selectValueContainer,GComboBox subCategory,SelectValue value){
		 this.reviewRRCRequestDataExtraction.setsubCategoryValues(selectValueContainer, subCategory, value);
	 }
	 @Override
	 public void setsourceValues(BeanItemContainer<SelectValue> selectValueContainer,GComboBox source,SelectValue value){
		 this.reviewRRCRequestDataExtraction.setsourceValues(selectValueContainer, source, value);
	 }
}
