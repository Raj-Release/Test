 ...
 *
 */
public class ProcessRRCRequestWizardViewImpl extends AbstractMVPView implements ProcessRRCRequestDataExtractionWizard {
	
	@Inject
	private Instance<ProcessRRCRequestDataExtractionView> processRRCRequestDataExtractionObj;
	private ProcessRRCRequestDataExtractionView processRRCRequestDataExtraction;
...
/*		item.addNestedProperty("documentDetails.documentCheckList");
	...
	public void initView(RRCDTO rrcDTO)
	{
		this.bean = rrcDTO;
		mainPanel = new Panel();
		...
		initBinder();	
		processRRCRequestDataExtraction = processRRCRequestDataExtractionObj.get();
		processRRCRequestDataExtraction.init(bean,wizard);
		wizard.addStep(this.processRRCRequestDataExtraction,"Process RRC Request");
...
//					}
	...
	public void wizardCompleted(WizardCompletedEvent event) {
		if(processRRCRequestDataExtraction.onAdvance())
		{
	...
	public boolean onSave() {
	 ...
	 public void setsubCategoryValues(BeanItemContainer<SelectValue> selectValueContainer,GComboBox subCategory,SelectValue value){
		 this.processRRCRequestDataExtraction.setsubCategoryValues(selectValueContainer, subCategory, value);
	 }
	 @Override
	 public void setsourceValues(BeanItemContainer<SelectValue> selectValueContainer,GComboBox source,SelectValue value){
		 this.processRRCRequestDataExtraction.setsourceValues(selectValueContainer, source, value);
	 }
}
