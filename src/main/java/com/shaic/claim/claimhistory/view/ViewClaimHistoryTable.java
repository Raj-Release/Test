...
public class ViewClaimHistoryTable extends GBaseTable<ViewClaimHistoryDTO> {
	...
	private static final Object[] NATURAL_COL_ORDER = new Object[] {
			"typeofClaim","docrecdfrom","rodtype","billClassif","referenceNo","dateAndTime", "userID","userName", "claimStage", "status",
			"userRemark" };
