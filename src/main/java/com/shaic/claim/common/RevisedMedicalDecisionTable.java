...
public class RevisedMedicalDecisionTable extends ViewComponent {
	...
	public Object[] CLAIM_REQUEST_VISIBLE_COLUMNS_Non_GMC = new Object[] {
			"diagOrProcedure", "description", "pedImpactOnDiagnosis","reasonForNotPaying", "packageAmt", "restrictionSI","utilizedAmt", "availableAmout", "subLimitAmount", "subLimitUtilAmount", "subLimitAvaliableAmt"};
	...
	public Object[] VISIBLE_COLUMNS_WITH_REVERSE_NON_GMC = new Object[] {
			"diagOrProcedure", "description", /*"pedOrExclusion",*/  	"pedImpactOnDiagnosis","reasonForNotPaying", "isAmbChargeApplicable","ambulanceCharge","amountConsidered","agreedPackageAmt", "packageAmt","reasonForPkgChange", "minimumAmountOfAmtconsideredAndPackAmt","coPayType","coPayPercentage", "coPayAmount", "netAmount", "amtWithAmbulanceCharge","subLimitAmount", "subLimitUtilAmount", "subLimitAvaliableAmt", "restrictionSI","utilizedAmt", "availableAmout", "minimumAmount", "reverseAllocatedAmt"};
	...
	public Object[] SPECIFIC_PRODUCT_VISIBLE_COLUMNS_WITH_REVERSE_NON_GMC = new Object[] {
			"diagOrProcedure", "description", "pedImpactOnDiagnosis","reasonForNotPaying","isAmbChargeApplicable","ambulanceCharge","amountConsidered", "agreedPackageAmt", "packageAmt", "reasonForPkgChange", "subLimitAmount", "subLimitUtilAmount", "subLimitAvaliableAmt", "minimumAmountOfAmtconsideredAndPackAmt","coPayType","coPayPercentage", "coPayAmount","netAmount", "amtWithAmbulanceCharge", "restrictionSI","utilizedAmt", "availableAmout", "minimumAmount", "reverseAllocatedAmt"};
	...
	public Object[] CLAIM_REQUEST_VISIBLE_COLUMNS_WITH_REVERSE_Non_GMC = new Object[] {
			"diagOrProcedure", "description", "pedImpactOnDiagnosis","reasonForNotPaying", "packageAmt", "restrictionSI","utilizedAmt", "availableAmout", "subLimitAmount", "subLimitUtilAmount", "subLimitAvaliableAmt", "reverseAllocatedAmt"};
	
	public Object[] VISIBLE_COLUMNS_FOR_GMC_PRODUCT = new Object[] {
			"diagOrProcedure", "description","isAmbChargeApplicable","ambulanceCharge","amountConsidered","agreedPackageAmt", "packageAmt","reasonForPkgChange", "minimumAmountOfAmtconsideredAndPackAmt", "coPayType","coPayPercentage", "coPayAmount", "netAmount", "amtWithAmbulanceCharge","subLimitAmount", "subLimitUtilAmount", "subLimitAvaliableAmt","minimumAmount", "reverseAllocatedAmt"};
	...
	public Object[] VISIBLE_COLUMNS_BILLING_AND_FA_NON_GMC = new Object[] {
			"diagOrProcedure", "description", "pedImpactOnDiagnosis", "considerForPaymnt", "reasonForNotPaying", "isAmbChargeApplicable","ambulanceCharge","amountConsidered", "packageAmt", "minimumAmountOfAmtconsideredAndPackAmt","coPayType", "coPayPercentage", "coPayAmount", "netAmount", "amtWithAmbulanceCharge","sublimitYesOrNo","sublimitValues","subLimitAmount", "subLimitUtilAmount", "subLimitAvaliableAmt", "restrictionSI","utilizedAmt", "availableAmout", "minimumAmount", "reverseAllocatedAmt"};
	
	public Object[] SPECIFIC_PRODUCT_VISIBLE_COLUMNS_WITH_REVERSE_BILLING_AND_FA = new Object[] {
			"diagOrProcedure", "description", "pedOrExclusion","isAmbChargeApplicable","ambulanceCharge","amountConsidered", "packageAmt" ,"sublimitYesOrNo","sublimitValues","subLimitAmount", "subLimitUtilAmount", "subLimitAvaliableAmt", "minimumAmountOfAmtconsideredAndPackAmt", "coPayType","coPayPercentage", "coPayAmount","netAmount", "amtWithAmbulanceCharge", "restrictionSI","utilizedAmt", "availableAmout", "minimumAmount", "reverseAllocatedAmt"};
	
	public Object[] SPECIFIC_PRODUCT_VISIBLE_COLUMNS_WITH_REVERSE_BILLING_AND_FA_NON_GMC = new Object[] {
			"diagOrProcedure", "description", "pedImpactOnDiagnosis","reasonForNotPaying","isAmbChargeApplicable","ambulanceCharge","amountConsidered", "packageAmt" ,"sublimitYesOrNo","sublimitValues","subLimitAmount", "subLimitUtilAmount", "subLimitAvaliableAmt", "minimumAmountOfAmtconsideredAndPackAmt", "coPayType","coPayPercentage", "coPayAmount","netAmount", "amtWithAmbulanceCharge", "restrictionSI","utilizedAmt", "availableAmout", "minimumAmount", "reverseAllocatedAmt"};
...
//		table.setWidth("100%");
		...
		if(this.bean.getNewIntimationDTO().getPolicy().getProduct().getCalculationTemplateFlag().toLowerCase().equalsIgnoreCase("a")) {
			 ...
			 if(this.bean.getNewIntimationDTO().getPolicy().getProductType().getKey().intValue() != 2904){
				table.setVisibleColumns(VISIBLE_COLUMNS_WITH_REVERSE_NON_GMC);
			}
			else{ 
			...
			if(this.bean.getNewIntimationDTO().getPolicy().getProduct().getCode().equalsIgnoreCase(ReferenceTable.STAR_CRITICARE_OTHER_BANKS) ||
			...
			if(null != presenterString && ((SHAConstants.BILLING.equalsIgnoreCase(presenterString)) ||
				...
				if(this.bean.getNewIntimationDTO().getPolicy().getProductType().getKey().intValue() == 2904){
					...
					table.setVisibleColumns(VISIBLE_COLUMNS_BILLING_AND_FA_NON_GMC);
				}
			...
			if(bean.getNewIntimationDTO().getPolicy().getProduct().getCode().equalsIgnoreCase(SHAConstants.GMC_CONTINUITY_PRODUCT_CODE) &&
				...
				table.setVisibleColumns(SPECIFIC_PRODUCT_VISIBLE_COLUMNS_WITH_REVERSE_NON_GMC);
			}
			if(presenterString!=null && presenterString.equalsIgnoreCase(SHAConstants.MEDICAL_APPROVAL_CLAIM_REQUEST_MEDICAL_DECISION) &&
			...
			if(null != presenterString && ((SHAConstants.BILLING.equalsIgnoreCase(presenterString)) ||
					(SHAConstants.FINANCIAL.equalsIgnoreCase(presenterString)))){
				if(this.bean.getNewIntimationDTO().getPolicy().getProductType().getKey().intValue() == 2904){
					table.setVisibleColumns(SPECIFIC_PRODUCT_VISIBLE_COLUMNS_WITH_REVERSE_BILLING_AND_FA);
				}	
				else{
					table.setVisibleColumns(SPECIFIC_PRODUCT_VISIBLE_COLUMNS_WITH_REVERSE_BILLING_AND_FA_NON_GMC);
				}	
			}
			
		} 
		
		if(null != presenterString && (SHAConstants.MEDICAL_APPROVAL.equalsIgnoreCase(presenterString))){
		...
		if(table.getColumnHeader("reasonForNotPaying") != null) {
...
//		manageListeners();
	...
	public void setVisibleColumns() {
		...
		if(this.bean.getNewIntimationDTO().getPolicy().getProductType().getKey().intValue() == 2904){
			...
			this.table.setVisibleColumns(CLAIM_REQUEST_VISIBLE_COLUMNS_WITH_REVERSE_Non_GMC);
		}
	}
...
//				consideredAmountListener(null,field);
			...
			else if("reasonForNotPaying".equals(propertyId)){
				
				GComboBox field = new GComboBox();
				field.setData(diagnosisProcedureTableDto);
				tableRow.put("reasonForNotPaying", field);				
				
				HashMap<String, AbstractField<?>> hashMap = tableItem.get(diagnosisProcedureTableDto);
				GComboBox considerPaymentCmb = (GComboBox) hashMap.get("considerForPaymnt");
				SelectValue considerPaymentSelect = considerPaymentCmb != null ? (SelectValue) considerPaymentCmb.getValue() : null;
				...
				if(bean.getNewIntimationDTO().getPolicy().getProductType() != null 
						...
						&& considerPaymentSelect != null 	
						&& ReferenceTable.COMMONMASTER_NO.equals(diagnosisProcedureTableDto.getConsiderForPaymnt().getId())) {
					field.setEnabled(true);
				}
				else
				{
				...
				addReasonForNotPayingValues(field, "reasonForNotPaying");
...
//				consideredAmountListener(null,field);
	...
	private void calculationMethodForMedicalDecision(Component component, Boolean isCopay) {
		...
		if(bean.getNewIntimationDTO().getIsPaayasPolicy() || bean.getNewIntimationDTO().getIsTataPolicy()) {
			coPayPercentage.setEnabled(false);
		}
	 ...
	 public void addCoPayPercentage(ComboBox comboBox, DiagnosisProcedureTableDTO dto){
		   BeanItemContainer<SelectValue> coPayContainer = new BeanItemContainer<SelectValue>(SelectValue.class);
		    ...
		    if(coPayPercentageValues == null || coPayPercentageValues.isEmpty()) {
		    	...
		    	if(null != bean.getNewIntimationDTO().getPolicy().getProduct().getKey() &&
		    		...
		    		if((bean.getPreauthDataExtractionDetails().getSection() != null &&
		    				...
		    				((bean.getPreauthDataExtractionDetails().getSectionDetailsDTO().getSection() != null && ReferenceTable.LUMPSUM_SECTION_CODE.equals(bean.getPreauthDataExtractionDetails().getSectionDetailsDTO().getSection().getCommonValue())) &&
		    						(bean.getPreauthDataExtractionDetails().getSectionDetailsDTO().getCover() != null && ReferenceTable.LUMPSUM_COVER_CODE.equals(bean.getPreauthDataExtractionDetails().getSectionDetailsDTO().getCover().getCommonValue())))){
		    ...
		    for (String string : coPayPercentageValues) {
				if(SHAUtils.getDoubleFromStringWithComma(string).equals(0)) {
					isZeroAvail = true;
					break;
				}
			}
			...
			//Added for GMC Copay to show max of copay
            if(ReferenceTable.getGMCProductList().containsKey(bean.getNewIntimationDTO().getPolicy().getProduct().getKey())){
                     coPayContainer.sort(new Object[] {"value"}, new boolean[] {true});
                     SelectValue selectValue = coPayContainer.getIdByIndex(coPayContainer.size()-1);
                     comboBox.setValue(selectValue);
                     comboBox.setNullSelectionAllowed(false);
                     dto.setCoPayPercentage(selectValue);        
                }
			...
			comboBox.setItemCaptionPropertyId("value");
			 ...
			 /*if(! bean.getIsReverseAllocation() && !bean.getIsDefaultCopaySaved() && ("Y").equalsIgnoreCase(bean.getNewIntimationDTO().getCopayFlag())) {
				 coPayContainer.sort(new Object[] {"value"}, new boolean[] {true});
				 SelectValue selectValue = coPayContainer.getIdByIndex(coPayContainer.size()-1);
				 comboBox.setValue(selectValue);
				 comboBox.setNullSelectionAllowed(false);
		...
		public ValueChangeListener considerForPaymentListener(){
			ValueChangeListener listener = new ValueChangeListener() {
				...
				public void valueChange(ValueChangeEvent event) {
					...
					TextField amountConsidered = (TextField)hashMap.get("amountConsidered");
					GComboBox notPayingReasonCmb = hashMap.get("reasonForNotPaying") != null ? (GComboBox)hashMap.get("reasonForNotPaying") : null;
						...
						Boolean componentValue = SHAConstants.YES
							...
							if(componentValue){
								...
								if(bean.getNewIntimationDTO().getPolicy().getProductType() != null
									...
									notPayingReasonCmb.setValue(diagnosisProcedureTableDto.getReasonForNotPaying());
								}
								else {
									if(notPayingReasonCmb != null){
										notPayingReasonCmb.setValue(null);
			...
			if (sublimitApplicableCombo != null) {
				sublimitApplicableCombo.addListener(new Listener() {
					...
					public void componentEvent(Event event) {
						...
						SelectValue sublimitApplicable = component.getValue() != null ? (SelectValue)component.getValue() : null;
						
						if (sublimitApplicable != null
								&& sublimitApplicable.getId().equals(ReferenceTable.COMMONMASTER_YES)) {
				...
				sublimitApplicableCombo.addListener(new Listener() {
					...
					public void componentEvent(Event event) {
						...
						if(presenterString != null && presenterString.equalsIgnoreCase(SHAConstants.BILLING)){
							...
							fireViewEvent(FinancialProcessPagePresenter.EDIT_SUBLIMIT_VALUES, caluculationInputValues, pedValidationDTO,bean);
						}
						calculationMethodForMedicalDecision(component, false);
					 }else{
...
//			Label noteLabel = new Label("<b style = 'color: red;'>  In case of query next step would be </br> viewing the letter and confirming </b>", ContentMode.HTML);
			...
			buttonsNamewithType.put(GalaxyButtonTypesEnum.OK.toString(), "OK");
			HashMap<String, Button> messageBoxButtons = GalaxyAlertBox
					.createAlertBox(errMsg, buttonsNamewithType);
		...
		private void addReasonForNotPayingValues(GComboBox reasonNotPayingCombo, String tableColumnName) {
			
			
			List<SelectValue> applicableList = new ArrayList<SelectValue>();
			...
			if(referenceData != null) {
				...
				if(containerValues != null) {
					applicableList = containerValues.getItemIds();
				}	
			
			DiagnosisProcedureTableDTO pedValidation =  (DiagnosisProcedureTableDTO)reasonNotPayingCombo.getData();
			
			HashMap<String, AbstractField<?>> hashMap = tableItem
					.get(pedValidation);
			
			ComboBox cmbConsiderPaymentBox = (ComboBox) hashMap.get("considerForPaymnt");
			
			if(cmbConsiderPaymentBox != null && cmbConsiderPaymentBox.getValue() != null) {
				SelectValue considerPaymentSelect = (SelectValue) cmbConsiderPaymentBox.getValue();
				
				if (pedValidation.getReasonForNotPaying() != null
						&& containerValues != null
						&& bean.getNewIntimationDTO().getPolicy().getProductType().getKey().intValue() != 2904) {
					
					if(applicableList != null && !applicableList.isEmpty() && ReferenceTable.COMMONMASTER_NO.equals(considerPaymentSelect.getId())){
						for (SelectValue selectValue : applicableList) {
							if(pedValidation.getReasonForNotPaying().getId().equals(selectValue.getId()) 
				...
				else if(ReferenceTable.COMMONMASTER_YES.equals(considerPaymentSelect.getId()) || applicableList == null || applicableList.isEmpty()){
					reasonNotPayingCombo.setValue(null);
		...
		public String isValidForPayment() {
			...
			if(itemIds != null && !itemIds.isEmpty()) {
				...
				for (DiagnosisProcedureTableDTO bean : itemIds) {
					...
					if((this.bean.getNewIntimationDTO().getPolicy().getProductType() != null 
						&& this.bean.getNewIntimationDTO().getPolicy().getProductType().getKey() != null
						&& this.bean.getNewIntimationDTO().getPolicy().getProductType().getKey().intValue() != 2904) 
						&& (bean.getConsiderForPaymnt() != null && ReferenceTable.COMMONMASTER_NO.equals(bean.getConsiderForPaymnt().getId()))){
						
						if(bean.getReasonForNotPaying() == null){
							errMsg = "Please Select Reason For Not Paying";
						}
					}
				}
			}	
		...
		//IMSSUPPOR-29851
		public Double getCopayAmountInDiagProd(){
			 return SHAUtils.getDoubleValueFromString(this.table.getColumnFooter("coPayAmount"));
		 }
