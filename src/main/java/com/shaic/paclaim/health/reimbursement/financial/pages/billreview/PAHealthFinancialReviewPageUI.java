...
//		dialog.setCaption("Alert");
	...
	public Component getContent() {
		...
		firstFLayout = new FormLayout(admissionDate, cmbRoomCategory, illnessFLayout, cmbSpecifyIllness, preauthApprovedAmt, cmbSection);
		}
		else
		{
			firstFLayout = new FormLayout(admissionDate, cmbRoomCategory, illnessFLayout, cmbSpecifyIllness, preauthApprovedAmt, cmbSection,domicillaryHospitalisation);
		}
