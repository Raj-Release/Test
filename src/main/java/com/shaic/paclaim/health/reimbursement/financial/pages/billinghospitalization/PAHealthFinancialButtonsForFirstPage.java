...
public class PAHealthFinancialButtonsForFirstPage  extends ViewComponent {
	...
	private void addListener() {
		...
		cancelROD.addClickListener(new Button.ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
					fireViewEvent(PAHealthFinancialReviewPagePresenter.FINANCIAL_CANCEL_ROD, null);
			}
		});
		...
		referCoordinatorBtn.addClickListener(new Button.ClickListener() {
			...
			@Override
			public void buttonClick(ClickEvent event) {
				fireViewEvent(PAHealthFinancialReviewPagePresenter.FINANCIAL_REFERCOORDINATOR_EVENT,null);
			}
		});
		...
		referToMedicalApproverBtn.addClickListener(new Button.ClickListener() {
			...
			@Override
			public void buttonClick(ClickEvent event) {
				fireViewEvent(PAHealthFinancialReviewPagePresenter.FINANCIAL_REFER_TO_MEDICAL_APPROVER_EVENT, null);
			}
		});
		...
		referToBillingBtn.addClickListener(new Button.ClickListener() {
			...
			@Override
			public void buttonClick(ClickEvent event) {
				fireViewEvent(PAHealthFinancialReviewPagePresenter.FIANANCIAL_REFER_TO_BILLING_EVENT, null);
			}
		});
		...
		rejectBtn.addClickListener(new Button.ClickListener() {
			...
			@Override
			public void buttonClick(ClickEvent event) {
				fireViewEvent(PAHealthFinancialReviewPagePresenter.FIANANCIAL_REJECT_EVENT,null);				
			}
		});
		 ...
		 referToBillEntry.addClickListener(new Button.ClickListener() {
				...
				@Override
				public void buttonClick(ClickEvent event) {
					fireViewEvent(PAHealthFinancialReviewPagePresenter.FINANCIAL_REFER_TO_BILL_ENTRY, null);
				}
			});
