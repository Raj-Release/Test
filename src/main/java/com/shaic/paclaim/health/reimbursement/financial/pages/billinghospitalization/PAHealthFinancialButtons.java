...
public class PAHealthFinancialButtons  extends ViewComponent {
	...
	private void addListener() {
		...
		approveBtn.addClickListener(new Button.ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				...
				Double payableAmt = bean.getPreauthDataExtractionDetails().getPayableToInsured() != null ? bean.getPreauthDataExtractionDetails().getPayableToInsured() : 0d;
				...
				if(validatePolicyStatus(bean.getPolicyDto().getPolicyNumber()) || (intimationDtls.getAllowApprovalFlag() != null && intimationDtls.getAllowApprovalFlag().equalsIgnoreCase("Y"))){
					...
					if(bean.getIsHospitalizationRODApproved()) {
						fireViewEvent(PAHealthFinancialHospitalizationPagePresenter.FIANANCIAL_APPROVE_EVENT, null);
					} else {
		...
		cancelROD.addClickListener(new Button.ClickListener() {
			...
			@Override
			public void buttonClick(ClickEvent event) {
					fireViewEvent(PAHealthFinancialHospitalizationPagePresenter.FINANCIAL_CANCEL_ROD, null);
			}
		});
...
//		});
		...
		queryBtn.addClickListener(new Button.ClickListener() {
			...
			@Override
			public void buttonClick(ClickEvent event) {
				fireViewEvent(PAHealthFinancialHospitalizationPagePresenter.FIANANCIAL_QUERY_EVENT,null);
			}
		});
		...
		rejectBtn.addClickListener(new Button.ClickListener() {
			...
			@Override
			public void buttonClick(ClickEvent event) {
				fireViewEvent(PAHealthFinancialHospitalizationPagePresenter.FIANANCIAL_REJECT_EVENT,null);				
			}
		});
		...
		referCoordinatorBtn.addClickListener(new Button.ClickListener() {
			...
			@Override
			public void buttonClick(ClickEvent event) {
				fireViewEvent(PAHealthFinancialHospitalizationPagePresenter.FINANCIAL_REFERCOORDINATOR_EVENT,null);
			}
		});
		...
		initiateFieldVisitBtn.addClickListener(new Button.ClickListener() {
			...
			@Override
			public void buttonClick(ClickEvent event) {
				fireViewEvent(PAHealthFinancialHospitalizationPagePresenter.FIANANCIAL_FVR_EVENT,null);
			}
		});
		...
		initiateInvestigationBtn.addClickListener(new Button.ClickListener() {
			...
			@Override
			public void buttonClick(ClickEvent event) {
				fireViewEvent(PAHealthFinancialHospitalizationPagePresenter.FIANANCIAL_INVESTIGATION_EVENT,null);
			}
		});
		...
		referToSpecialistBtn.addClickListener(new Button.ClickListener() {
			...
			@Override
			public void buttonClick(ClickEvent event) {
				fireViewEvent(PAHealthFinancialHospitalizationPagePresenter.FIANANCIAL_REFER_TO_SPECIALIST_EVENT,null);
			}
		});
		...
		referToMedicalApproverBtn.addClickListener(new Button.ClickListener() {
			...
			@Override
			public void buttonClick(ClickEvent event) {
				fireViewEvent(PAHealthFinancialHospitalizationPagePresenter.FINANCIAL_REFER_TO_MEDICAL_APPROVER_EVENT, null);
			}
		});
		...
		referToBillingBtn.addClickListener(new Button.ClickListener() {
			...
			@Override
			public void buttonClick(ClickEvent event) {
				fireViewEvent(PAHealthFinancialHospitalizationPagePresenter.FIANANCIAL_REFER_TO_BILLING_EVENT, null);
			}
		});
		 ...
		 referToBillEntry.addClickListener(new Button.ClickListener() {
				...
				@Override
				public void buttonClick(ClickEvent event) {
					fireViewEvent(PAHealthFinancialHospitalizationPagePresenter.FINANCIAL_HOSPITALIZATION_REFER_TO_BILL_ENTRY, null);
				}
			});
...
//		dynamicFrmLayout.addComponent(sentToCPU);
	...
	public void generateFieldsForApproval() {
		...
		if(bean.getDocumentReceivedFromId() != null && bean.getDocumentReceivedFromId().equals(ReferenceTable.RECEIVED_FROM_HOSPITAL)){
			...
			submitBtnForhospitalDiscountWithListener = getSubmitButtonWithListener(dialog1);
			submitBtnForhospitalDiscountWithListener.setEnabled(hospitalDiscountChk.getValue());
			
			VLayout.addComponent(hospitalDiscountHorizontalLayout,0);
			...
			public void buttonClick(ClickEvent event) {
				...
				if(isValid()) {
					...
					wizard.getFinishButton().setEnabled(true);
						...
						financialDecisionCommunicationObj.init(bean, wizard);
