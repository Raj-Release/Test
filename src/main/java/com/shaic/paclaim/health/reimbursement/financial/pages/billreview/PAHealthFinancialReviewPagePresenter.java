...
@ViewInterface(PAHealthFinancialReviewPageWizard.class)
public class PAHealthFinancialReviewPagePresenter extends AbstractMVPPresenter<PAHealthFinancialReviewPageWizard>{
	...
	public static final String BILLING_HOSPITAL_BENEFITS = "pa_health_financial_hospital_cash_benefits";
	public static final String BILLING_PATIENT_CARE_BENEFITS = "pa_health_financial_patiet_care_benefits";
	public static final String BILLING_REVIEW_SET_UP_REFERENCE = "pa_health_financial_review_set_up_reference";
	public static final String BILLING_DETAILS_UPDATE = "pa_health_financial_billing update details";
	public static final String VIEW_BILLING_WORKSHEET = "pa_health_billing_worksheet";


	public static final String BILLING_TREATMENT_TYPE_CHANGED = "pa_health_financial_treatment_type_changed";


	public static final String BILLING_COORDINATOR = "pa_health_financial_coordinator";
	
	public static final String GET_SEC_COVER = "pa_health_financial_get_sec_cover";
	
	public static final String GET_SUB_COVER = "pa_health_financial_get_sub_cover";


	public static final String BILLING_PATIENT_STATUS_CHANGED = "pa_health_financial_patient_status_changed";
	public static final String CLAIM_HOSPITAL_BENEFITS = "pa_health_claim_financial_hospital_benefits";
	public static final String CLAIM_PATIENT_CARE_BENEFITS = "pa_health_claim_financial_patient_care_benefits";


	public static final String BILL_ENTRY_TABLE_CATEGORY_DROPDOWN_VALUE = "pa_health_financial_bill_entry_category_dropdown_values";
	
	public static final String FINANCIAL_BILL_REVIEW_IRDA_LEVEL2_VALUES = "pa_health_financial_bill_review_irda_level2_values";
	
	public static final String FINANCIAL_BILL_REVIEW_IRDA_LEVEL3_VALUES = "pa_health_financial_bill_review_irda_level3_values";



	public static final String BILL_ENTRY_COMPLETION_STATUS = "pa_health_financial_bill_entry_completion_status";
	
	public static final String SAVE_PATIENT_CARE_TABLE_VALUES = "pa_health_Update Patient Care Table Values for Claim financial";
	
	public static final String SAVE_HOSPITAL_CASH_TABLE_VALUES = "pa_health_Update Hospital Cash Table Values for Claim financial";


	public static final String COMPARE_WITH_PREVIOUS_ROD = "pa_health_process_financial_compare_with_previous_rod";
	
//	public static final String FA_SETUP_IFSC_DETAILS = "pa_health_FA_Setup_ifsc_details";
	
	public static final String GET_MAPPING_DATA = "pa_health_financial_get_mapping_data";
	
	public static final String FINANCIAL_CANCEL_ROD="pa_health_financial_cancel_rod_for_first_page";
	
	public static final String FINANCIAL_REFERCOORDINATOR_EVENT = "pa_health_financial_refer_to_coordinator_event_for_first_page";
	
	public static final String FIANANCIAL_REFER_TO_BILLING_EVENT = "pa_health_financial_refer_to_billing_event_for_first_page";
	
	public static final String FINANCIAL_REFER_TO_MEDICAL_APPROVER_EVENT = "pa_health_financial_refer_to_medical_approver_event_for_first_page";
	
	public static final String FIANANCIAL_REJECT_EVENT = "pa_health_financial_reject_event_for_first_page";
	
	public static final String FA_SAVE_BILL_ENTRY_VALUES = "pa_health_fa_save_bill_entry_values";
	
	public static final String FA_LOAD_BILL_DETAILS_VALUES = "pa_health_fa_load_bill_details_values";
	public static final String FINANCIAL_REFER_TO_BILL_ENTRY = "pa_health_financial_refer_to_bill_entry";
	
	public static final String FA_UPDATE_PRODUCT_BASED_AMT = "pa_health_fa_update_product_based_amt";
	
/*	public static final String PA_CLAIM_VERIFIED_ACCOUNT_DETAIL_SAVE ="PA Claim Save Account Verificatin Details";
	
	public static final String PA_CLAIM_VERIFICATION_ACCOUNT_DETAILS ="PA Claim Account Verificatin Details";
	...
	public static final String SETUP_NOMINEE_IFSC_DETAILS_PA_FA = "Setup Nominee IFSC Details PA FA";
	
	public static final String GENERATE_DOMICILLARY_FIELDS = "pa_health_financial_generate_domicillary_fields";
	public static final String SET_DB_DETAILS_TO_REFERENCE_DATA = "pa_health_financial_set_db_details_to_reference_data";
...
/*			@SuppressWarnings("static-access")
			public void saveVerifiedAccount(
					@Observes @CDIEvent(PA_CLAIM_VERIFIED_ACCOUNT_DETAIL_SAVE) final ParameterDTO parameters) {		
				PreauthDTO preauthDTO = (PreauthDTO) parameters.getPrimaryParameter();
			...
			public void setVerifictaionAccountDetails(
					@Observes @CDIEvent(PA_CLAIM_VERIFICATION_ACCOUNT_DETAILS) final ParameterDTO parameters) {
				PreauthDTO preauthDTO = (PreauthDTO) parameters.getPrimaryParameter();
