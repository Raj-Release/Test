...
@ViewInterface(PAHealthClaimRequestWizard.class)
public class PAHealthClaimRequestWizardPresenter extends
AbstractMVPPresenter<PAHealthClaimRequestWizard> {
	...
	public static final String SUBMIT_MEDICAL_APPROVAL_CLAIM_REQUEST = "submit_pa_health_medical_approval_claim_request";
	
	public static final String SAVE_CLAIM_REQUEST_RRC_REQUEST_VALUES = "save_pa_health_claim_request_rrc_request_values";
	public static final String CLAIM_REQUEST_LOAD_RRC_REQUEST_DROP_DOWN_VALUES = "pa_health_claim_request_load_rrc_request_drop_down_values";
	public static final String CLAIM_LOAD_EMPLOYEE_DETAILS = "pa_health_claim_load_employee_details";
	public static final String VALIDATE_CLAIM_REQUEST_USER_RRC_REQUEST = "pa_health_validate_claim_request_user_rrc_request";
	public static final String CLAIM_REQUEST_RRC_REQUEST_SUB_CATEGORY_VALUES = "claim_request_rrc_request_sub_category_values";

	public static final String CLAIM_REQUEST_RRC_REQUEST_SOURCE_VALUES = "claim_request_rrc_request_source_values";
	
	public static final String PA_HEALTH_CLAIM_REQUEST_INITIATE_INV_EVENT = "pa_health_claim_request_parallel_initiate_invstigation_event";

	public static final String PA_HEALTH_CLAIM_REQUEST_QUERY_BUTTON_EVENT = "pa_health_request_parallel_query_button_event";
	
	public static final String PA_HEALTH_SUBMIT_PARALLEL_QUERY = "pa_health_submit_parallel_query";
	
	public static final String PA_HEALTH_CLAIM_REQUEST_FIELD_VISIT_EVENT = "pa_health_claim_request_parallel_FVR_event";
	...
	public void submitWizard(
		...
		if(isFirstRODApproved) {
			...
			Reimbursement reimbursement = reimbursementService.submitPAClaimRequest(reimbursementDTO);
	...
	public void setUpSubCategoryValues(
			@Observes @CDIEvent(CLAIM_REQUEST_RRC_REQUEST_SUB_CATEGORY_VALUES) final ParameterDTO parameters) {
	...
	public void setUpsourceValues(
			@Observes @CDIEvent(CLAIM_REQUEST_RRC_REQUEST_SOURCE_VALUES) final ParameterDTO parameters) {
	...
	public void generateFieldsForInvestigation(
			@Observes @CDIEvent(PA_HEALTH_CLAIM_REQUEST_INITIATE_INV_EVENT) final ParameterDTO parameters) {
		PreauthDTO preauthDTO = (PreauthDTO) parameters.getPrimaryParameter();
	...
	public void generateQueryLayout(
			@Observes @CDIEvent(PA_HEALTH_CLAIM_REQUEST_QUERY_BUTTON_EVENT) final ParameterDTO parameters) {
		view.generateQueryLayout();
	}
	

	public void submitParallelQuery(
			@Observes @CDIEvent(PA_HEALTH_SUBMIT_PARALLEL_QUERY) final ParameterDTO parameters) {
		PreauthDTO preauthDTO = (PreauthDTO) parameters.getPrimaryParameter();
		reimbursementServiceHealth.submitParallelQuery(preauthDTO);
	}
	
	public void generateFieldVisitLayout(
			@Observes @CDIEvent(PA_HEALTH_CLAIM_REQUEST_FIELD_VISIT_EVENT) final ParameterDTO parameters) {
