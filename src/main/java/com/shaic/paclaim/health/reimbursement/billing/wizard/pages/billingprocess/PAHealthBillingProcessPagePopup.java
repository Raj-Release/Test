...
import com.shaic.paclaim.health.reimbursement.financial.pages.billingprocess.PAHealthFinancialProcessPagePresenter;
...
public class PAHealthBillingProcessPagePopup extends ViewComponent {
		...
		if(previousPreauthList != null && !previousPreauthList.isEmpty()) {
			for (PreviousPreAuthTableDTO previousPreAuthTableDTO : previousPreauthList) {
				if (!(this.bean.getKey() != null && this.bean.getKey().equals(
					...
					fireViewEvent(PAHealthFinancialProcessPagePresenter.GET_PREAUTH_REQUESTED_AMOUT,
