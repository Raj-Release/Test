...
//	}
	...
	//	btnCancel.setDisableOnClick(true);
		...
		previousAccountDetailsTable.setPresenterString(SHAConstants.PA_ADD_ADDITIONAL_PAYMENT_INFO);
	...
	public void addCitySearchListener(){
		btnCitySearch.addClickListener(new ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				...
				citySearchCriteriaWindow.setPresenterString(SHAConstants.PA_ADD_ADDITIONAL_PAYMENT_INFO);
	...
	public void addIFSCCodeListner()
	{
		btnIFCSSearch.addClickListener(new ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				...
				viewSearchCriteriaWindow.setPresenterString(SHAConstants.PA_ADD_ADDITIONAL_PAYMENT_INFO);
