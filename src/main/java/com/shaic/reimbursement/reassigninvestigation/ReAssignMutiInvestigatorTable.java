	...
	public class ImmediateFieldFactory extends DefaultFieldFactory {
		...
		public Field<?> createField(Container container, Object itemId,
			...
			if ("stateSelectValue".equals(propertyId)) {
				...
				if(investigDto.getAllocationToSelectValue() != null
						&& investigDto.getAllocationToSelectValue().getValue().equalsIgnoreCase("Private")){
					addCoordinatorTo(investigDto.getZoneSelectValue().getId(),box,investigDto.getCoordinatorSelectValue());
				}
...
//					investigatorNameComb.setValue(null);
					...
					if(selectedAllocation != null && selectedAllocation.getValue().equalsIgnoreCase("Private")){
						if(selectedZone != null){
							addCoordinatorTo(selectedZone.getId(),coordinatorComb,investigTableDTO.getCoordinatorSelectValue());
						}
					}
				}
			});			
	...
	public void addCoordinatorTo(Long selectedZone,ComboBox coordinatorValue,SelectValue value){
