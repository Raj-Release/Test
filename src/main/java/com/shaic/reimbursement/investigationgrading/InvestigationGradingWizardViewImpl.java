...
public class InvestigationGradingWizardViewImpl  extends AbstractMVPView
implements InvestigationGradingWizardView {
	...
	@Inject
	private Instance<InvestigationGradingPageView> assignInvestigatorViewImpl;
...
/*	@Inject
	...
	public void initView(AssignInvestigatorDto assignInvestigatorDto) {
		try{
			...
			// setHeight("100");
			InvestigationGradingPageView assignInvestigatorView = assignInvestigatorViewImpl.get();
			assignInvestigatorView.init(this.assignInvestigatorDto, wizard);
			wizard.addStep(assignInvestigatorView, "Investigaton Grading");
...
//			wizard.addStep(this.confirmationViewImpl, "Confirmation");
			...
			intimationDetailsCarousel.init(this.assignInvestigatorDto.getClaimDto()
					...
					.getClaimDto(), "Investigation Grading",assignInvestigatorDto.getDiagnosisName());
	...
	{
		fireViewEvent(InvestigationGradingWizardPresenter.VALIDATE_ASSIGN_INVESTIGATION_USER_RRC_REQUEST, preauthDTO);//, secondaryParameters);
	}
	...
	public void wizardCompleted(WizardCompletedEvent event) {
		...
		if(validatePage())
		{		
		fireViewEvent(InvestigationGradingWizardPresenter.INVESTIGATION_GRADING_SUBMIT, this.assignInvestigatorDto);
		}
	}
...
//						assignInvestigatorDto = new AssignInvestigatorDto();
		                if (!dialog.isConfirmed()) {
		                	...
		                	releaseHumanTask();
		                    fireViewEvent(MenuItemBean.SEARCH_INVESTIGATION_GRADING, null);
...
//		                    dialog.close();
	...
	public void buildSuccessLayout() {
		Label successLabel = new Label("<b style = 'color: black;'>Investigation Grading Submitted successfully !!!</b>", ContentMode.HTML);
...
//		Label noteLabel = new Label("<b style = 'color: red;'>  In case of query next step would be </br> viewing the letter and confirming </b>", ContentMode.HTML);
	...
	public Boolean validatePage() {
		// TODO Auto-generated method stub
		return assignInvestigatorViewImpl.get().validatePage();
	}
