 ...
 *
 */
public class SearchProcessClaimFinancialsViewImpl extends AbstractMVPView implements SearchProcessClaimFinancialsView{

	
	@Inject
	private SearchProcessClaimFinancialsForm  searchForm;
	
	@Inject
	private SearchProcessClaimFinancialsTable searchResultTable;
	...
	public void doSearch() {
		...
		if(claimedAmountFrom != null && claimedAmountTo != null)  {
			if((claimedAmountFrom > claimedAmountTo || claimedAmountTo < claimedAmountFrom)) {
				...
				fireViewEvent(SearchProcessClaimFinancialsPresenter.SEARCH_BUTTON_CLICK, searchDTO,userName,passWord);
			}
	...
	public void resetSearchResultTableValues() {
		...
		while(componentIter.hasNext())
		{
			...
			if(comp instanceof SearchProcessClaimFinancialsTable)
			{
				((SearchProcessClaimFinancialsTable) comp).removeRow();
			}
		}
	...
	public void list(Page<SearchProcessClaimFinancialsTableDTO> tableRows) {
		...
		else
		{
			...
			else
			{
				...
				HashMap<String, String> buttonsNamewithType = new HashMap<String, String>();
				buttonsNamewithType.put(GalaxyButtonTypesEnum.OK.toString(), "Process Claim Financials Home");
