 ...
 */
@Stateless
public class SearchProcessClaimFinancialsService extends AbstractDAO<Intimation>{
	...
	public SearchProcessClaimFinancialsService() {
		super();
	...
	public  Page<SearchProcessClaimFinancialsTableDTO> search(
			...
			try{
				...
				String pccFlag = null != searchFormDTO && searchFormDTO.getPccFlag() != null ? searchFormDTO.getPccFlag().getValue() != null ? searchFormDTO.getPccFlag().getValue() : null : null;
...
//					ClassificationType classification = null;
				    ...
				    if( pccFlag != null){
						mapValues.put(SHAConstants.PCC_FLAG, pccFlag);		
					}
...
//						Integer taskNo = taskNumber.get(index);
				...
				//	Page<SearchProcessClaimFinancialsTableDTO> page = new Page<SearchProcessClaimFinancialsTableDTO>(taskList);
