 ...
 *
 */
public class SearchProcessClaimFinancialsForm extends SearchComponent<SearchProcessClaimFinancialsFormDTO> {
	...
	@Inject
	private SearchProcessClaimFinancialsTable searchTable;
...
//	private ComboBox cmbPriorityNew;
	...
	public VerticalLayout mainVerticalLayout(){
		...
		pccFlag = binder.buildAndBind("PCC Flag","pccFlag",ComboBox.class);
...
//		cmbPriorityNew = binder.buildAndBind("Priority","priorityNew",ComboBox.class);
		...
		FormLayout formLayoutMiddleRight = new FormLayout(txtPolicyNo,cbxType,pccFlag);
	...
	public void setUpDropDownValues(BeanItemContainer<SelectValue> claimType,
		...
		BeanItemContainer<SelectValue> selectValueForPCCFlag = masterService.getPCCFlagTypes();
		pccFlag.setContainerDataSource(selectValueForPCCFlag);
		pccFlag.setItemCaptionMode(ItemCaptionMode.PROPERTY);
		pccFlag.setItemCaptionPropertyId("value");	
