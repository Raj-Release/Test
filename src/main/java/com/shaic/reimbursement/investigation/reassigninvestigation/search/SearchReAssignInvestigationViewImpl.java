 ...
 *
 */
public class SearchReAssignInvestigationViewImpl extends AbstractMVPView implements SearchReAssignInvestigationView{

	
	@Inject
	private SearchReAssignInvestigationForm  searchForm;
	
	@Inject
	private SearchReAssignInvestigationTable searchResultTable;
	...
	public void doSearch() {
		...
		fireViewEvent(SearchReAssignInvestigationPresenter.SEARCH_RE_ASSIGN_INV_BUTTON_CLICK, searchDTO,userName,passWord);
	...
	public void resetSearchResultTableValues() {
		...
		while(componentIter.hasNext())
		{
			...
			if(comp instanceof SearchReAssignInvestigationTable)
			{
				((SearchReAssignInvestigationTable) comp).removeRow();
			}
		}
