...
//	}
	...
	public void getCoordinator(
		...
		Long selectedZone = (Long) parameters.getPrimaryParameter();
		...
		coordinatorContainer = masterService.getPrivateInvestigationCoordinator(selectedZone);
	...
	public void getZones(
		...
		if(selectedAllocationTo != null && selectedAllocationTo.equalsIgnoreCase("Private")){
			...
			zoneCode = masterService.getZoneCodes();
