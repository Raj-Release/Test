...
//		this.popup = popup;
		...
		FormLayout firstForm = new FormLayout(txtIntimationNo,cmbDocumentRecvFrom,txtAmountSettled,txtAmountRecoverable,instrumentNumber,paymentType,payableName,remittanceBankName);
