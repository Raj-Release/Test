 ...
 *
 */
public class SearchProcessClaimRequestTableDTO extends AbstractTableDTO  implements Serializable{
	...
	private SearchProcessClaimRequestFormDTO searchDTO;
	...
	public void setSearchDTO(SearchProcessClaimRequestFormDTO searchDTO) {
