...
//	@Inject
	...
	public HorizontalLayout commonButtonsLayout()
	{
		...
		HorizontalLayout vLayout = new HorizontalLayout(hflayout, btnLumen, btnRRC, btnViewInvestigationDetails);
...
//					"Process Investigation Initiated");
			...
			reasonForRefferingFormLayout = new FormLayout(
					txtReasonForReferring, txtTriggerPointsToFocus);
