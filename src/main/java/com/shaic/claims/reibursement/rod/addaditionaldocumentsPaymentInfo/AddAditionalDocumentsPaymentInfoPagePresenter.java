...
public class AddAditionalDocumentsPaymentInfoPagePresenter extends
	...
	public static final String PAYMENT_INFO_SETUP_DROPDOWN_VALUES = "payment_info_setup_dropdown_values";
	
	public static final String SUBMIT_PAYMENT_INFO_DOCUMENTS = "submit_payment_info_documents";
	
	public static final String DELETE_PAYMENT_INFO_DOCUMENTS = "delete_payment_info_documents";
	
	public static final String EDIT_PAYMENT_INFO_DOCUMENTS = "edit_payment_info_documents";
	
	public static final String UPDATE_BEAN = "PAYMENT_INFO_UPDATE BEAN";
	
	public static final String SUBMIT_DETAILS = "submit_add_additional_documents_payment_info";
	
	public static final String SETUP_PAYMENT_INFO_DOCUMENTS_PAYABLE_DETAILS  = "setup_payable_details_addl_docs_payment_info";
	
	public static final String SETUP_PAYMENT_INFO_DOCUMENTS_IFSC_DETAILS  = "setup_ifsc_details_addl_docs_payment_info";
	
	public static final String PAYMENT_INFO_POPULATE_PREVIOUS_ACCT_DETAILS = "payment_info_financial_populate_previous_acct_details";
