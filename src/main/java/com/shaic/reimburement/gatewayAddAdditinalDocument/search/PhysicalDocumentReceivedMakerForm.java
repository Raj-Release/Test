...
public class PhysicalDocumentReceivedMakerForm extends SearchComponent<PhysicalDocumentReceivedMakerFormDTO>{
	...
	public void init() {
		...
		mainPanel.setCaption("Received Physical Documents (Maker)");
	...
	{
		this.binder = new BeanFieldGroup<PhysicalDocumentReceivedMakerFormDTO>(PhysicalDocumentReceivedMakerFormDTO.class);
		this.binder.setItemDataSource(new PhysicalDocumentReceivedMakerFormDTO());
