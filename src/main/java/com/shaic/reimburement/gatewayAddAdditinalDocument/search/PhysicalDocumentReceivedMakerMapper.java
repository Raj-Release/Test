...
public class PhysicalDocumentReceivedMakerMapper {
	...
	public static void getAllMapValues() {
		...
		ClassMapBuilder<Reimbursement, PhysicalDocumentReceivedMakerTableDTO> claimClassMap = mapperFactor.classMap(Reimbursement.class, PhysicalDocumentReceivedMakerTableDTO.class);
	...
	public static List<PhysicalDocumentReceivedMakerTableDTO> getIntimationDTO(List<Reimbursement> intimationData){
