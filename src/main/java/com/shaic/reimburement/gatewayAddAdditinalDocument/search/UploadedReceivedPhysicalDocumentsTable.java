		...
		table.addGeneratedColumn("received", new Table.ColumnGenerator() {
			...
			@Override
		      public Object generateCell(final Table source, final Object itemId, Object columnId) {
		    	...
		    	final OptionGroup received = new OptionGroup();
		...
		table.addGeneratedColumn("ignore", new Table.ColumnGenerator() {
			...
			@Override
		      public Object generateCell(final Table source, final Object itemId, Object columnId) {
		    	...
		    	final OptionGroup ignore = new OptionGroup();
		    	...
		    	editButton.addClickListener(new Button.ClickListener() {
					...
					public void buttonClick(ClickEvent event) {
						...
						uploadDTO.setIsEdit(true);
						 ...
						 if (SHAConstants.ADD_ADDITIONAL_DOCUMENTS.equalsIgnoreCase(presenterString))
