...
//		MENU_ITEMS_PERMISSION_MAPPING.put(SHOW_PROCESS_FIELD_VISIT, showPRocessFieldVisit);
		...
		MenuItem physicalDocument = new MenuItem(22l,"Received Physical document (Maker)", PHYSICAL_DOCUMENT);
		MenuItem createRODMenu = new MenuItem(3l, "Create ROD", CREATE_ROD);
		...
		MenuItem hrmCoOrdinator = new MenuItem(34l, "HRM Coordinator(PCC Process)", HRM_CO_ORDINATOR);
		...
		postCashlessCell.addChild(hrmCoOrdinator);
	...
	//	misc.addChild(topUpPolicyMasterMenu);
		...
		MenuItem registerClaim = new MenuItem(11l, "Create & Register OP Request",
				REGISTER_CLAIM_OP);
		...
		MENU_ITEMS_PERMISSION_MAPPING.put(OP_HEALTH_CHECK_PROCESSING,
				op_healthCheckProcessing);
...
//		MENU_ITEMS_PERMISSION_MAPPING.put(CASHLESS_PAGE, cashLessMenu);
		...
		MenuItem holdMonitorScreen = new MenuItem(30l, "Hold Monitoring",
				HOLD_MONITOR_SCREEN);
...
>>>>>>> 39366ce448e44155c696cd39af09ce82ffb2a6f8*/
		...
		reportList.add(BILL_RECIECVED_STATUS_REPORT);
