...
//			BeanItemContainer<SelectValue> productNameCode, BeanItemContainer<SelectValue> selectValueContainerForType, BeanItemContainer<SelectValue> selectValueForPriority, BeanItemContainer<SelectValue> statusByStage);
	...
	void setViewForSearchClaimFinancial(
			Class<SearchProcessClaimFinancialsView> class1, boolean b, BeanItemContainer<SelectValue> claimType, BeanItemContainer<SelectValue> productName, BeanItemContainer<SelectValue> cpuCode, BeanItemContainer<SelectValue> type, BeanItemContainer<SelectValue> selectValueForPriority, BeanItemContainer<SelectValue> statusByStage);
	...
	void setViewCreateBatchOp(
			...
			BeanItemContainer<SpecialSelectValue> selectValueContainerForProduct,
			BeanItemContainer<SelectValue> docVerified,
			BeanItemContainer<SelectValue> selectValueContainerForPaymentMode, boolean b);
...
//			boolean selectInNavigationTree, BeanItemContainer<SelectValue> type,BeanItemContainer<SelectValue> userList,BeanItemContainer<SelectValue> cpuCode);
