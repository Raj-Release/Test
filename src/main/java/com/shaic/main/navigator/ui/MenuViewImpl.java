...
//import com.shaic.claim.clearcashless.ClearCashlessViewImpl;
...
import com.shaic.claim.hospitalscoring.HospitalScoringDetailsViewImpl;
...
import com.shaic.claim.pcc.wizard.SearchPccCoOrdinatorViewImpl;
...
import com.shaic.claim.processdatacorrection.search.SearchProcessDataCorrectionViewImpl;
...
import com.shaic.claim.registration.convertClaimToReimbursement.search.SearchConvertReimbursementView;
import com.shaic.claim.registration.convertClaimToReimbursement.search.SearchConvertReimbursementViewImpl;
...
//------------------------------------------------------------------------R3-Search-Narenj------------------------------------------------------
	...
	public void setViewsProcessClaimClaimOP(
		...
		searchProcessClaimOPViewImpl.init(claimTypeContainer);
		tree.setSelectedView(viewClass);
		((AbstractMVPView) view).enter();
	}
...
public void setViewCreateBatchOp(
	...
	createBatchViewImpl.init(selectValueContainerForType, selectValueContainerForCPUCode, selectValueContainerForClaimant, 
			selectValueContainerForClaimType, selectValueContainerForPaymentStatus,selectValueContainerForProduct,docVerified,selectValueContainerForPaymentMode);
	tree.setSelectedView(viewClass);
	if (selectInNavigationTree) {
		tree.setSelectedView(viewClass);
	}
...
//	}
	...
	public void setViewSettlementProcessClaimClaimOP(
		...
		createSettlementLetterBatchViewImpl.init(selectValueContainerForType, selectValueContainerForCPUCode, selectValueContainerForClaimant, 
				selectValueContainerForClaimType, selectValueContainerForPaymentStatus,selectValueContainerForProduct,selectValueContainerForPaymentMode,docVerified);
		tree.setSelectedView(viewClass);
		if (selectInNavigationTree) {
			tree.setSelectedView(viewClass);
		}
